...
function of_nativeint(n) {
  var n$1 = Curry._1(Z.Int.of_nativeint, n);
  return {
          num: n$1,
          den: Z.Int.one
        };
...
function of_float(d) {
  if (d === Pervasives.infinity) {
    ...
    return minus_inf;
  } else if (Pervasives.classify_float(d) === /* FP_nan */4) {
    return undef;
  } else {
    var match = Caml_float.caml_frexp_float(d);
    var m = Curry._1(Z.Int.of_float, Caml_float.caml_ldexp_float(match[0], 53));
    var e = match[1] - 53 | 0;
    if (e >= 0) {
...
function to_nativeint(x) {
  return Curry._1(Z.Int.to_nativeint, eval_to_int(x));
}
...
function mul(x, y) {
  if (x.den === Z.Int.zero || y.den === Z.Int.zero) {
    return {
            num: Curry._1(Z.Int.of_int, Caml_int32.imul(Curry._1(Z.Int.sign, x.num), Curry._1(Z.Int.sign, y.num))),
            den: Z.Int.zero
          };
  } else {
...
function of_nativeint$1(n) {
  var n$1 = Curry._1(Z.Int32.of_nativeint, n);
  return {
          num: n$1,
          den: Z.Int32.one
        };
...
function of_float$1(d) {
  if (d === Pervasives.infinity) {
    ...
    var match = Caml_float.caml_frexp_float(d);
    var m = Curry._1(Z.Int32.of_float, Caml_float.caml_ldexp_float(match[0], 53));
    var e = match[1] - 53 | 0;
    if (e >= 0) {
...
function to_nativeint$1(x) {
  return Curry._1(Z.Int32.to_nativeint, eval_to_int$1(x));
}
...
function mul$1(x, y) {
  if (x.den === Z.Int32.zero || y.den === Z.Int32.zero) {
    return {
            num: Curry._1(Z.Int32.of_int, Caml_int32.imul(Curry._1(Z.Int32.sign, x.num), Curry._1(Z.Int32.sign, y.num))),
            den: Z.Int32.zero
          };
  } else {
...
function of_nativeint$2(n) {
  var n$1 = Curry._1(Z.Int64.of_nativeint, n);
  return {
          num: n$1,
          den: Z.Int64.one
        };
...
function of_float$2(d) {
  if (d === Pervasives.infinity) {
    ...
    var match = Caml_float.caml_frexp_float(d);
    var m = Curry._1(Z.Int64.of_float, Caml_float.caml_ldexp_float(match[0], 53));
    var e = match[1] - 53 | 0;
    if (e >= 0) {
...
function to_nativeint$2(x) {
  return Curry._1(Z.Int64.to_nativeint, eval_to_int$2(x));
}
...
function mul$2(x, y) {
  if (x.den === Z.Int64.zero || y.den === Z.Int64.zero) {
    return {
            num: Curry._1(Z.Int64.of_int, Caml_int32.imul(Curry._1(Z.Int64.sign, x.num), Curry._1(Z.Int64.sign, y.num))),
            den: Z.Int64.zero
          };
  } else {
...
function make_real$3(n, d) {
  if (n === Z.Nativeint.zero || d === Z.Nativeint.one) {
    return {
            num: n,
            den: Z.Nativeint.one
          };
  } else {
    var g = Curry._2(Z.Nativeint.gcd, n, d);
    if (g === Z.Nativeint.one) {
      return {
              num: n,
              den: d
            };
      ...
      return {
              num: Curry._2(Z.Nativeint.divexact, n, g),
              den: Curry._2(Z.Nativeint.divexact, d, g)
            };
    }
  }
}
...
function make$3(n, d) {
  var sd = Curry._1(Z.Nativeint.sign, d);
  if (sd === 0) {
    return {
            num: Curry._1(Z.Nativeint.of_int, Curry._1(Z.Nativeint.sign, n)),
            den: Z.Nativeint.zero
          };
  } else if (sd > 0) {
    return make_real$3(n, d);
  } else {
    return make_real$3(Curry._1(Z.Nativeint.neg, n), Curry._1(Z.Nativeint.neg, d));
  }
}
...
function of_int$3(n) {
  var n$1 = Curry._1(Z.Nativeint.of_int, n);
  return {
          num: n$1,
          den: Z.Nativeint.one
        };
...
function of_int32$3(n) {
  var n$1 = Curry._1(Z.Nativeint.of_int32, n);
  return {
          num: n$1,
          den: Z.Nativeint.one
        };
...
function of_int64$3(n) {
  var n$1 = Curry._1(Z.Nativeint.of_int64, n);
  return {
          num: n$1,
          den: Z.Nativeint.one
        };
...
function of_nativeint$3(n) {
  var n$1 = Curry._1(Z.Nativeint.of_nativeint, n);
  return {
          num: n$1,
          den: Z.Nativeint.one
        };
...
function of_bigint$3(n) {
  var n$1 = Curry._1(Z.Nativeint.of_bigint, n);
  return {
          num: n$1,
          den: Z.Nativeint.one
        };
...
function of_ints$3(n, d) {
  return make$3(Curry._1(Z.Nativeint.of_int, n), Curry._1(Z.Nativeint.of_int, d));
}

var zero_num$3 = Z.Nativeint.zero;

var zero_den$3 = Z.Nativeint.one;
...
var one_num$3 = Z.Nativeint.one;

var one_den$3 = Z.Nativeint.one;
...
var minus_one_num$3 = Z.Nativeint.minus_one;

var minus_one_den$3 = Z.Nativeint.one;
...
var inf_num$3 = Z.Nativeint.one;

var inf_den$3 = Z.Nativeint.zero;
...
var minus_inf_num$3 = Z.Nativeint.minus_one;

var minus_inf_den$3 = Z.Nativeint.zero;
...
var undef_num$3 = Z.Nativeint.zero;

var undef_den$3 = Z.Nativeint.zero;
...
function of_float$3(d) {
  if (d === Pervasives.infinity) {
    ...
    var match = Caml_float.caml_frexp_float(d);
    var m = Curry._1(Z.Nativeint.of_float, Caml_float.caml_ldexp_float(match[0], 53));
    var e = match[1] - 53 | 0;
    if (e >= 0) {
      var n = Curry._2(Z.Nativeint.shift_left, m, e);
      return {
              num: n,
              den: Z.Nativeint.one
            };
    } else {
      return make_real$3(m, Curry._2(Z.Nativeint.shift_left, Z.Nativeint.one, -e | 0));
    }
  }
}
...
function of_string$3(s) {
  try {
    var i = $$String.index(s, /* "/" */47);
    return make$3(Curry._3(Z.Nativeint.of_substring, s, 0, i), Curry._3(Z.Nativeint.of_substring, s, i + 1 | 0, (s.length - i | 0) - 1 | 0));
  }
  catch (exn){
    if (exn === Caml_builtin_exceptions.not_found) {
      if (s === "inf" || s === "+inf") {
        ...
        var n = Curry._1(Z.Nativeint.of_string, s);
        return {
                num: n,
                den: Z.Nativeint.one
              };
...
function classify$3(n) {
  if (n.den === Z.Nativeint.zero) {
    var match = Curry._1(Z.Nativeint.sign, n.num);
    switch (match) {
      case -1 :
          return /* MINF */2;
      case 0 :
  ...
  } else if (n.num === Z.Nativeint.zero) {
    return /* ZERO */0;
  } else {
    return /* NZERO */4;
  }
...
function sign$3(x) {
  return Curry._1(Z.Nativeint.sign, x.num);
}

function equal$3(x, y) {
  if (Curry._2(Z.Nativeint.equal, x.num, y.num)) {
    return Curry._2(Z.Nativeint.equal, x.den, y.den);
  } else {
    return false;
  }
}
...
function compare$3(x, y) {
  ...
  if (match$1 !== 2) {
    if (x.den === y.den) {
      return Curry._2(Z.Nativeint.compare, x.num, y.num);
    } else {
      return Curry._2(Z.Nativeint.compare, Curry._2(Z.Nativeint.mul, x.num, y.den), Curry._2(Z.Nativeint.mul, y.num, x.den));
    }
  } else {
    return 1;
  }
...
function to_string$3(n) {
  ...
  switch (match) {
    ...
    case /* UNDEF */3 :
        return "undef";
    case /* NZERO */4 :
        if (Curry._2(Z.Nativeint.equal, n.den, Z.Nativeint.one)) {
          return Curry._1(Z.Nativeint.to_string, n.num);
        } else {
          return Curry._1(Z.Nativeint.to_string, n.num) + ("/" + Curry._1(Z.Nativeint.to_string, n.den));
        }
...
function eval_to_int$3(x) {
  return Curry._2(Z.Nativeint.div, x.num, x.den);
}

function to_int$3(x) {
  return Curry._1(Z.Nativeint.to_int, eval_to_int$3(x));
}

function to_int32$3(x) {
  return Curry._1(Z.Nativeint.to_int32, eval_to_int$3(x));
}

function to_int64$3(x) {
  return Curry._1(Z.Nativeint.to_int64, eval_to_int$3(x));
}

function to_nativeint$3(x) {
  return Curry._1(Z.Nativeint.to_nativeint, eval_to_int$3(x));
}

function to_bigint$3(x) {
  return Curry._1(Z.Nativeint.to_bigint, eval_to_int$3(x));
}
...
function to_float$3(x) {
  ...
  switch (match) {
    ...
    case /* NZERO */4 :
        var p = x.num;
        var q = x.den;
        var np = Curry._1(Z.Nativeint.numbits, p);
        var nq = Curry._1(Z.Nativeint.numbits, q);
        if (np <= 53 && nq <= 53) {
          return Caml_int64.to_float(Curry._1(Z.Nativeint.to_int64, p)) / Caml_int64.to_float(Curry._1(Z.Nativeint.to_int64, q));
        } else {
          var n = 55 - (np - nq | 0) | 0;
          var match$1 = n >= 0 ? /* tuple */[
              Curry._2(Z.Nativeint.shift_left, p, n),
              q
            ] : /* tuple */[
              p,
              Curry._2(Z.Nativeint.shift_left, q, -n | 0)
            ];
          var match$2 = Curry._2(Z.Nativeint.ediv_rem, match$1[0], match$1[1]);
          var f = Curry._2(Z.Nativeint.round_to_float, match$2[0], Curry._1(Z.Nativeint.sign, match$2[1]) === 0);
          return Caml_float.caml_ldexp_float(f, -n | 0);
        }
...
function neg$3(x) {
  return {
          num: Curry._1(Z.Nativeint.neg, x.num),
          den: x.den
        };
}
...
function abs$3(x) {
  return {
          num: Curry._1(Z.Nativeint.abs, x.num),
          den: x.den
        };
}
...
function aors$3(zaors, x, y) {
  if (x.den === y.den) {
    ...
    return make_real$3(Curry._2(zaors, Curry._2(Z.Nativeint.mul, x.num, y.den), Curry._2(Z.Nativeint.mul, y.num, x.den)), Curry._2(Z.Nativeint.mul, x.den, y.den));
  }
}

function add$3(x, y) {
  if (x.den === Z.Nativeint.zero || y.den === Z.Nativeint.zero) {
    var match = classify$3(x);
    var match$1 = classify$3(y);
    var exit = 0;
    var exit$1 = 0;
    ...
    return aors$3(Z.Nativeint.add, x, y);
  }
}
...
function sub$3(x, y) {
  if (x.den === Z.Nativeint.zero || y.den === Z.Nativeint.zero) {
    ...
    return aors$3(Z.Nativeint.sub, x, y);
  }
}
...
function mul$3(x, y) {
  if (x.den === Z.Nativeint.zero || y.den === Z.Nativeint.zero) {
    return {
            num: Curry._1(Z.Nativeint.of_int, Caml_int32.imul(Curry._1(Z.Nativeint.sign, x.num), Curry._1(Z.Nativeint.sign, y.num))),
            den: Z.Nativeint.zero
          };
  } else {
    return make_real$3(Curry._2(Z.Nativeint.mul, x.num, y.num), Curry._2(Z.Nativeint.mul, x.den, y.den));
  }
}

function inv$3(x) {
  var match = Curry._1(Z.Nativeint.sign, x.num);
  switch (match) {
    case -1 :
        return {
                num: Curry._1(Z.Nativeint.neg, x.den),
                den: Curry._1(Z.Nativeint.neg, x.num)
              };
    case 0 :
        break;
    case 1 :
...
function div$3(x, y) {
  if (Curry._1(Z.Nativeint.sign, y.num) >= 0) {
    return mul$3(x, {
                num: y.den,
                den: y.num
              });
    ...
    return mul$3(x, {
                num: Curry._1(Z.Nativeint.neg, y.den),
                den: Curry._1(Z.Nativeint.neg, y.num)
              });
  }
}
...
function mul_2exp$3(x, n) {
  if (x.den === Z.Nativeint.zero) {
    ...
    return make_real$3(Curry._2(Z.Nativeint.shift_left, x.num, n), x.den);
  }
}
...
function div_2exp$3(x, n) {
  if (x.den === Z.Nativeint.zero) {
    ...
    return make_real$3(x.num, Curry._2(Z.Nativeint.shift_left, x.den, n));
  }
}
...
function make$4(n, d) {
  ...
  if (sd === 0) {
    ...
    return make_real$4(Curry._1(Z.Bigint.neg, n), Curry._1(Z.Bigint.neg, d));
  }
}
...
function of_nativeint$4(n) {
  var n$1 = Curry._1(Z.Bigint.of_nativeint, n);
  return {
          num: n$1,
          den: Z.Bigint.one
        };
...
function of_ints$4(n, d) {
  return make$4(Curry._1(Z.Bigint.of_int, n), Curry._1(Z.Bigint.of_int, d));
}

var zero_num$4 = Z.Bigint.zero;

var zero_den$4 = Z.Bigint.one;
...
var one_num$4 = Z.Bigint.one;

var one_den$4 = Z.Bigint.one;
...
var minus_one_num$4 = Z.Bigint.minus_one;

var minus_one_den$4 = Z.Bigint.one;
...
var inf_num$4 = Z.Bigint.one;

var inf_den$4 = Z.Bigint.zero;
...
var minus_inf_num$4 = Z.Bigint.minus_one;

var minus_inf_den$4 = Z.Bigint.zero;
...
var undef_num$4 = Z.Bigint.zero;

var undef_den$4 = Z.Bigint.zero;
...
function of_float$4(d) {
  if (d === Pervasives.infinity) {
    ...
    var match = Caml_float.caml_frexp_float(d);
    var m = Curry._1(Z.Bigint.of_float, Caml_float.caml_ldexp_float(match[0], 53));
    var e = match[1] - 53 | 0;
    if (e >= 0) {
      ...
      return make_real$4(m, Curry._2(Z.Bigint.shift_left, Z.Bigint.one, -e | 0));
    }
  }
}
...
function of_string$4(s) {
  try {
    var i = $$String.index(s, /* "/" */47);
    return make$4(Curry._3(Z.Bigint.of_substring, s, 0, i), Curry._3(Z.Bigint.of_substring, s, i + 1 | 0, (s.length - i | 0) - 1 | 0));
  }
  catch (exn){
    if (exn === Caml_builtin_exceptions.not_found) {
      if (s === "inf" || s === "+inf") {
...
function to_int$4(x) {
  return Curry._1(Z.Bigint.to_int, eval_to_int$4(x));
}

function to_int32$4(x) {
  return Curry._1(Z.Bigint.to_int32, eval_to_int$4(x));
}

function to_int64$4(x) {
  return Curry._1(Z.Bigint.to_int64, eval_to_int$4(x));
}

function to_nativeint$4(x) {
  return Curry._1(Z.Bigint.to_nativeint, eval_to_int$4(x));
}

function to_bigint$4(x) {
  return Curry._1(Z.Bigint.to_bigint, eval_to_int$4(x));
}
...
function aors$4(zaors, x, y) {
  if (x.den === y.den) {
    return make_real$4(Curry._2(zaors, x.num, y.num), x.den);
  } else {
    return make_real$4(Curry._2(zaors, Curry._2(Z.Bigint.mul, x.num, y.den), Curry._2(Z.Bigint.mul, y.num, x.den)), Curry._2(Z.Bigint.mul, x.den, y.den));
  }
}
...
function add$4(x, y) {
  if (x.den === Z.Bigint.zero || y.den === Z.Bigint.zero) {
    ...
    return aors$4(Z.Bigint.add, x, y);
  }
}
...
function sub$4(x, y) {
  if (x.den === Z.Bigint.zero || y.den === Z.Bigint.zero) {
    ...
    return aors$4(Z.Bigint.sub, x, y);
  }
}
...
function mul$4(x, y) {
  if (x.den === Z.Bigint.zero || y.den === Z.Bigint.zero) {
    return {
            num: Curry._1(Z.Bigint.of_int, Caml_int32.imul(Curry._1(Z.Bigint.sign, x.num), Curry._1(Z.Bigint.sign, y.num))),
            den: Z.Bigint.zero
          };
  } else {
    return make_real$4(Curry._2(Z.Bigint.mul, x.num, y.num), Curry._2(Z.Bigint.mul, x.den, y.den));
  }
}
...
function mul_2exp$4(x, n) {
  if (x.den === Z.Bigint.zero) {
    ...
    return make_real$4(Curry._2(Z.Bigint.shift_left, x.num, n), x.den);
  }
}
...
function div_2exp$4(x, n) {
  if (x.den === Z.Bigint.zero) {
    ...
    return make_real$4(x.num, Curry._2(Z.Bigint.shift_left, x.den, n));
  }
}
...
function Q(funarg) {
  ...
  var of_nativeint = function (n) {
    var n$1 = Curry._1(funarg.of_nativeint, n);
    return {
            num: n$1,
            den: funarg.one
          };
  ...
  var of_float = function (d) {
    if (d === Pervasives.infinity) {
      ...
      var match = Caml_float.caml_frexp_float(d);
      var m = Curry._1(funarg.of_float, Caml_float.caml_ldexp_float(match[0], 53));
      var e = match[1] - 53 | 0;
      if (e >= 0) {
  ...
  var to_nativeint = function (x) {
    return Curry._1(funarg.to_nativeint, eval_to_int(x));
  };
  ...
  var mul = function (x, y) {
    if (x.den === funarg.zero || y.den === funarg.zero) {
      return {
              num: Curry._1(funarg.of_int, Caml_int32.imul(Curry._1(funarg.sign, x.num), Curry._1(funarg.sign, y.num))),
              den: funarg.zero
            };
    } else {
...
var QBigint = {
  M: {
    ...
    asr: div_2exp$4,
    $tilde$: of_int$4,
    $slash$slash: of_ints$4,
    $tilde$$: eval_of_int$4,
    $slash$slash$slash: make$4,
    $eq: equal$4,
    $less: lt$4,
    $great: gt$4,
    $less$eq: leq$4,
