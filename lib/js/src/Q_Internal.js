...
function make_real(n, d) {
  if (n === Z.Int[/* zero */1] || d === Z.Int[/* one */2]) {
    ...
    var g = Curry._2(Z.Int[/* gcd */52], n, d);
    if (g === Z.Int[/* one */2]) {
      return /* record */[
              /* num */n,
              /* den */d
      ...
      return /* record */[
              /* num */Curry._2(Z.Int[/* divexact */25], n, g),
              /* den */Curry._2(Z.Int[/* divexact */25], d, g)
            ];
    }
  }
}
...
function make(n, d) {
  var sd = Curry._1(Z.Int[/* sign */47], d);
  if (sd === 0) {
    return /* record */[
            /* num */Curry._1(Z.Int[/* of_int */4], Curry._1(Z.Int[/* sign */47], n)),
            /* den */Z.Int[/* zero */1]
          ];
  } else if (sd > 0) {
...
function of_float(d) {
  if (d === Number.POSITIVE_INFINITY) {
    ...
    var e = match[1] - 53 | 0;
    if (e >= 0) {
      var n = Curry._2(Z.Int[/* shift_left */30], m, e);
      return /* record */[
              /* num */n,
              /* den */Z.Int[/* one */2]
            ];
    } else {
      return make_real(m, Curry._2(Z.Int[/* shift_left */30], Z.Int[/* one */2], -e | 0));
    }
  }
}
...
function classify(n) {
  if (n[/* den */1] === Z.Int[/* zero */1]) {
    var match = Curry._1(Z.Int[/* sign */47], n[/* num */0]);
...
function sign(x) {
  return Curry._1(Z.Int[/* sign */47], x[/* num */0]);
}

function equal(x, y) {
  if (Curry._2(Z.Int[/* equal */42], x[/* num */0], y[/* num */0])) {
    return Curry._2(Z.Int[/* equal */42], x[/* den */1], y[/* den */1]);
  } else {
    return false;
  }
}
...
function compare(x, y) {
  ...
  if (exit === 1) {
    if (x[/* den */1] === y[/* den */1]) {
      return Curry._2(Z.Int[/* compare */41], x[/* num */0], y[/* num */0]);
    } else {
      return Curry._2(Z.Int[/* compare */41], Curry._2(Z.Int[/* mul */18], x[/* num */0], y[/* den */1]), Curry._2(Z.Int[/* mul */18], y[/* num */0], x[/* den */1]));
    }
  }
...
function to_string(n) {
  ...
  switch (match) {
    ...
    case 3 : 
        return "undef";
    case 4 : 
        if (Curry._2(Z.Int[/* equal */42], n[/* den */1], Z.Int[/* one */2])) {
          return Curry._1(Z.Int[/* to_string */40], n[/* num */0]);
        } else {
          return Curry._1(Z.Int[/* to_string */40], n[/* num */0]) + ("/" + Curry._1(Z.Int[/* to_string */40], n[/* den */1]));
        }
...
function to_int(x) {
  return Curry._1(Z.Int[/* to_int */33], eval_to_int(x));
}

function to_int32(x) {
  return Curry._1(Z.Int[/* to_int32 */34], eval_to_int(x));
}

function to_int64(x) {
  return Curry._1(Z.Int[/* to_int64 */35], eval_to_int(x));
}

function to_nativeint(x) {
  return Curry._1(Z.Int[/* to_nativeint */36], eval_to_int(x));
}

function to_bigint(x) {
  return Curry._1(Z.Int[/* to_bigint */37], eval_to_int(x));
}
...
function to_float(x) {
  ...
  switch (match) {
    ...
    case 4 : 
        var p = x[/* num */0];
        var q = x[/* den */1];
        var np = Curry._1(Z.Int[/* numbits */32], p);
        var nq = Curry._1(Z.Int[/* numbits */32], q);
        if (np <= 53 && nq <= 53) {
          return Caml_int64.to_float(Curry._1(Z.Int[/* to_int64 */35], p)) / Caml_int64.to_float(Curry._1(Z.Int[/* to_int64 */35], q));
        } else {
          var n = 55 - (np - nq | 0) | 0;
          var match$1 = n >= 0 ? /* tuple */[
              Curry._2(Z.Int[/* shift_left */30], p, n),
              q
            ] : /* tuple */[
              p,
              Curry._2(Z.Int[/* shift_left */30], q, -n | 0)
            ];
          var match$2 = Curry._2(Z.Int[/* ediv_rem */22], match$1[0], match$1[1]);
          var f = Curry._2(Z.Int[/* round_to_float */39], match$2[0], Curry._1(Z.Int[/* sign */47], match$2[1]) === 0);
...
function mul(x, y) {
  if (x[/* den */1] === Z.Int[/* zero */1] || y[/* den */1] === Z.Int[/* zero */1]) {
    return /* record */[
            /* num */Curry._1(Z.Int[/* of_int */4], Caml_int32.imul(Curry._1(Z.Int[/* sign */47], x[/* num */0]), Curry._1(Z.Int[/* sign */47], y[/* num */0]))),
            /* den */Z.Int[/* zero */1]
          ];
  } else {
...
function inv(x) {
  var match = Curry._1(Z.Int[/* sign */47], x[/* num */0]);
  var exit = 0;
  var switcher = match + 1 | 0;
  if (switcher > 2 || switcher < 0) {
    exit = 1;
...
function div(x, y) {
  if (Curry._1(Z.Int[/* sign */47], y[/* num */0]) >= 0) {
    return mul(x, /* record */[
                /* num */y[/* den */1],
                /* den */y[/* num */0]
              ]);
...
function mul_2exp(x, n) {
  if (x[/* den */1] === Z.Int[/* zero */1]) {
    ...
    return make_real(Curry._2(Z.Int[/* shift_left */30], x[/* num */0], n), x[/* den */1]);
  }
}
...
function div_2exp(x, n) {
  if (x[/* den */1] === Z.Int[/* zero */1]) {
    ...
    return make_real(x[/* num */0], Curry._2(Z.Int[/* shift_left */30], x[/* den */1], n));
  }
}
...
function make_real$1(n, d) {
  if (n === Z.Int32[/* zero */1] || d === Z.Int32[/* one */2]) {
    ...
    var g = Curry._2(Z.Int32[/* gcd */52], n, d);
    if (g === Z.Int32[/* one */2]) {
      return /* record */[
              /* num */n,
              /* den */d
      ...
      return /* record */[
              /* num */Curry._2(Z.Int32[/* divexact */25], n, g),
              /* den */Curry._2(Z.Int32[/* divexact */25], d, g)
            ];
    }
  }
}
...
function make$1(n, d) {
  var sd = Curry._1(Z.Int32[/* sign */47], d);
  if (sd === 0) {
    return /* record */[
            /* num */Curry._1(Z.Int32[/* of_int */4], Curry._1(Z.Int32[/* sign */47], n)),
            /* den */Z.Int32[/* zero */1]
          ];
  } else if (sd > 0) {
...
function of_float$1(d) {
  if (d === Number.POSITIVE_INFINITY) {
    ...
    var e = match[1] - 53 | 0;
    if (e >= 0) {
      var n = Curry._2(Z.Int32[/* shift_left */30], m, e);
      return /* record */[
              /* num */n,
              /* den */Z.Int32[/* one */2]
            ];
    } else {
      return make_real$1(m, Curry._2(Z.Int32[/* shift_left */30], Z.Int32[/* one */2], -e | 0));
    }
  }
}
...
function classify$1(n) {
  if (n[/* den */1] === Z.Int32[/* zero */1]) {
    var match = Curry._1(Z.Int32[/* sign */47], n[/* num */0]);
    var switcher = match + 1 | 0;
    if (switcher > 2 || switcher < 0) {
      return /* UNDEF */3;
    } else {
...
function sign$1(x) {
  return Curry._1(Z.Int32[/* sign */47], x[/* num */0]);
}

function equal$1(x, y) {
  if (Curry._2(Z.Int32[/* equal */42], x[/* num */0], y[/* num */0])) {
    return Curry._2(Z.Int32[/* equal */42], x[/* den */1], y[/* den */1]);
  } else {
    return false;
  }
}
...
function compare$1(x, y) {
  ...
  if (exit === 1) {
    if (x[/* den */1] === y[/* den */1]) {
      return Curry._2(Z.Int32[/* compare */41], x[/* num */0], y[/* num */0]);
    } else {
      return Curry._2(Z.Int32[/* compare */41], Curry._2(Z.Int32[/* mul */18], x[/* num */0], y[/* den */1]), Curry._2(Z.Int32[/* mul */18], y[/* num */0], x[/* den */1]));
    }
  }
...
function to_string$1(n) {
  ...
  switch (match) {
    ...
    case 3 : 
        return "undef";
    case 4 : 
        if (Curry._2(Z.Int32[/* equal */42], n[/* den */1], Z.Int32[/* one */2])) {
          return Curry._1(Z.Int32[/* to_string */40], n[/* num */0]);
        } else {
          return Curry._1(Z.Int32[/* to_string */40], n[/* num */0]) + ("/" + Curry._1(Z.Int32[/* to_string */40], n[/* den */1]));
        }
...
function to_int$1(x) {
  return Curry._1(Z.Int32[/* to_int */33], eval_to_int$1(x));
}

function to_int32$1(x) {
  return Curry._1(Z.Int32[/* to_int32 */34], eval_to_int$1(x));
}

function to_int64$1(x) {
  return Curry._1(Z.Int32[/* to_int64 */35], eval_to_int$1(x));
}

function to_nativeint$1(x) {
  return Curry._1(Z.Int32[/* to_nativeint */36], eval_to_int$1(x));
}

function to_bigint$1(x) {
  return Curry._1(Z.Int32[/* to_bigint */37], eval_to_int$1(x));
}
...
function to_float$1(x) {
  ...
  switch (match) {
    ...
    case 4 : 
        var p = x[/* num */0];
        var q = x[/* den */1];
        var np = Curry._1(Z.Int32[/* numbits */32], p);
        var nq = Curry._1(Z.Int32[/* numbits */32], q);
        if (np <= 53 && nq <= 53) {
          return Caml_int64.to_float(Curry._1(Z.Int32[/* to_int64 */35], p)) / Caml_int64.to_float(Curry._1(Z.Int32[/* to_int64 */35], q));
        } else {
          var n = 55 - (np - nq | 0) | 0;
          var match$1 = n >= 0 ? /* tuple */[
              Curry._2(Z.Int32[/* shift_left */30], p, n),
              q
            ] : /* tuple */[
              p,
              Curry._2(Z.Int32[/* shift_left */30], q, -n | 0)
            ];
          var match$2 = Curry._2(Z.Int32[/* ediv_rem */22], match$1[0], match$1[1]);
          var f = Curry._2(Z.Int32[/* round_to_float */39], match$2[0], Curry._1(Z.Int32[/* sign */47], match$2[1]) === 0);
          return Caml_float.caml_ldexp_float(f, -n | 0);
        }
...
function mul$1(x, y) {
  if (x[/* den */1] === Z.Int32[/* zero */1] || y[/* den */1] === Z.Int32[/* zero */1]) {
    return /* record */[
            /* num */Curry._1(Z.Int32[/* of_int */4], Caml_int32.imul(Curry._1(Z.Int32[/* sign */47], x[/* num */0]), Curry._1(Z.Int32[/* sign */47], y[/* num */0]))),
            /* den */Z.Int32[/* zero */1]
          ];
  } else {
...
function inv$1(x) {
  var match = Curry._1(Z.Int32[/* sign */47], x[/* num */0]);
  var exit = 0;
  var switcher = match + 1 | 0;
  if (switcher > 2 || switcher < 0) {
    exit = 1;
...
function div$1(x, y) {
  if (Curry._1(Z.Int32[/* sign */47], y[/* num */0]) >= 0) {
...
function mul_2exp$1(x, n) {
  if (x[/* den */1] === Z.Int32[/* zero */1]) {
    ...
    return make_real$1(Curry._2(Z.Int32[/* shift_left */30], x[/* num */0], n), x[/* den */1]);
  }
}
...
function div_2exp$1(x, n) {
  if (x[/* den */1] === Z.Int32[/* zero */1]) {
    ...
    return make_real$1(x[/* num */0], Curry._2(Z.Int32[/* shift_left */30], x[/* den */1], n));
  }
}
...
function make_real$2(n, d) {
  if (n === Z.Int64[/* zero */1] || d === Z.Int64[/* one */2]) {
    ...
    var g = Curry._2(Z.Int64[/* gcd */52], n, d);
    if (g === Z.Int64[/* one */2]) {
      return /* record */[
              /* num */n,
              /* den */d
      ...
      return /* record */[
              /* num */Curry._2(Z.Int64[/* divexact */25], n, g),
              /* den */Curry._2(Z.Int64[/* divexact */25], d, g)
            ];
    }
  }
}
...
function make$2(n, d) {
  var sd = Curry._1(Z.Int64[/* sign */47], d);
  if (sd === 0) {
    return /* record */[
            /* num */Curry._1(Z.Int64[/* of_int */4], Curry._1(Z.Int64[/* sign */47], n)),
            /* den */Z.Int64[/* zero */1]
          ];
  } else if (sd > 0) {
...
function of_float$2(d) {
  if (d === Number.POSITIVE_INFINITY) {
    ...
    var e = match[1] - 53 | 0;
    if (e >= 0) {
      var n = Curry._2(Z.Int64[/* shift_left */30], m, e);
      return /* record */[
              /* num */n,
              /* den */Z.Int64[/* one */2]
            ];
    } else {
      return make_real$2(m, Curry._2(Z.Int64[/* shift_left */30], Z.Int64[/* one */2], -e | 0));
    }
  }
}
...
function classify$2(n) {
  if (n[/* den */1] === Z.Int64[/* zero */1]) {
    var match = Curry._1(Z.Int64[/* sign */47], n[/* num */0]);
    var switcher = match + 1 | 0;
    if (switcher > 2 || switcher < 0) {
      return /* UNDEF */3;
    } else {
...
function sign$2(x) {
  return Curry._1(Z.Int64[/* sign */47], x[/* num */0]);
}

function equal$2(x, y) {
  if (Curry._2(Z.Int64[/* equal */42], x[/* num */0], y[/* num */0])) {
    return Curry._2(Z.Int64[/* equal */42], x[/* den */1], y[/* den */1]);
  } else {
    return false;
  }
}
...
function compare$2(x, y) {
  ...
  if (exit === 1) {
    if (x[/* den */1] === y[/* den */1]) {
      return Curry._2(Z.Int64[/* compare */41], x[/* num */0], y[/* num */0]);
    } else {
      return Curry._2(Z.Int64[/* compare */41], Curry._2(Z.Int64[/* mul */18], x[/* num */0], y[/* den */1]), Curry._2(Z.Int64[/* mul */18], y[/* num */0], x[/* den */1]));
    }
  }
...
function to_string$2(n) {
  ...
  switch (match) {
    ...
    case 3 : 
        return "undef";
    case 4 : 
        if (Curry._2(Z.Int64[/* equal */42], n[/* den */1], Z.Int64[/* one */2])) {
          return Curry._1(Z.Int64[/* to_string */40], n[/* num */0]);
        } else {
          return Curry._1(Z.Int64[/* to_string */40], n[/* num */0]) + ("/" + Curry._1(Z.Int64[/* to_string */40], n[/* den */1]));
        }
...
function to_int$2(x) {
  return Curry._1(Z.Int64[/* to_int */33], eval_to_int$2(x));
}

function to_int32$2(x) {
  return Curry._1(Z.Int64[/* to_int32 */34], eval_to_int$2(x));
}

function to_int64$2(x) {
  return Curry._1(Z.Int64[/* to_int64 */35], eval_to_int$2(x));
}

function to_nativeint$2(x) {
  return Curry._1(Z.Int64[/* to_nativeint */36], eval_to_int$2(x));
}

function to_bigint$2(x) {
  return Curry._1(Z.Int64[/* to_bigint */37], eval_to_int$2(x));
}
...
function to_float$2(x) {
  ...
  switch (match) {
    ...
    case 4 : 
        var p = x[/* num */0];
        var q = x[/* den */1];
        var np = Curry._1(Z.Int64[/* numbits */32], p);
        var nq = Curry._1(Z.Int64[/* numbits */32], q);
        if (np <= 53 && nq <= 53) {
          return Caml_int64.to_float(Curry._1(Z.Int64[/* to_int64 */35], p)) / Caml_int64.to_float(Curry._1(Z.Int64[/* to_int64 */35], q));
        } else {
          var n = 55 - (np - nq | 0) | 0;
          var match$1 = n >= 0 ? /* tuple */[
              Curry._2(Z.Int64[/* shift_left */30], p, n),
              q
            ] : /* tuple */[
              p,
              Curry._2(Z.Int64[/* shift_left */30], q, -n | 0)
            ];
          var match$2 = Curry._2(Z.Int64[/* ediv_rem */22], match$1[0], match$1[1]);
          var f = Curry._2(Z.Int64[/* round_to_float */39], match$2[0], Curry._1(Z.Int64[/* sign */47], match$2[1]) === 0);
          return Caml_float.caml_ldexp_float(f, -n | 0);
        }
...
function mul$2(x, y) {
  if (x[/* den */1] === Z.Int64[/* zero */1] || y[/* den */1] === Z.Int64[/* zero */1]) {
    return /* record */[
            /* num */Curry._1(Z.Int64[/* of_int */4], Caml_int32.imul(Curry._1(Z.Int64[/* sign */47], x[/* num */0]), Curry._1(Z.Int64[/* sign */47], y[/* num */0]))),
            /* den */Z.Int64[/* zero */1]
          ];
  } else {
...
function inv$2(x) {
  var match = Curry._1(Z.Int64[/* sign */47], x[/* num */0]);
  var exit = 0;
  var switcher = match + 1 | 0;
  if (switcher > 2 || switcher < 0) {
    exit = 1;
...
function div$2(x, y) {
  if (Curry._1(Z.Int64[/* sign */47], y[/* num */0]) >= 0) {
...
function mul_2exp$2(x, n) {
  if (x[/* den */1] === Z.Int64[/* zero */1]) {
    ...
    return make_real$2(Curry._2(Z.Int64[/* shift_left */30], x[/* num */0], n), x[/* den */1]);
  }
}
...
function div_2exp$2(x, n) {
  if (x[/* den */1] === Z.Int64[/* zero */1]) {
    ...
    return make_real$2(x[/* num */0], Curry._2(Z.Int64[/* shift_left */30], x[/* den */1], n));
  }
}
...
function make_real$3(n, d) {
  if (n === Z.Nativeint[/* zero */1] || d === Z.Nativeint[/* one */2]) {
    ...
    var g = Curry._2(Z.Nativeint[/* gcd */52], n, d);
    if (g === Z.Nativeint[/* one */2]) {
      ...
      return /* record */[
              /* num */Curry._2(Z.Nativeint[/* divexact */25], n, g),
              /* den */Curry._2(Z.Nativeint[/* divexact */25], d, g)
            ];
    }
  }
}
...
function make$3(n, d) {
  var sd = Curry._1(Z.Nativeint[/* sign */47], d);
  if (sd === 0) {
    return /* record */[
            /* num */Curry._1(Z.Nativeint[/* of_int */4], Curry._1(Z.Nativeint[/* sign */47], n)),
...
function of_float$3(d) {
  if (d === Number.POSITIVE_INFINITY) {
    ...
    var e = match[1] - 53 | 0;
    if (e >= 0) {
      var n = Curry._2(Z.Nativeint[/* shift_left */30], m, e);
      return /* record */[
              /* num */n,
              /* den */Z.Nativeint[/* one */2]
            ];
    } else {
      return make_real$3(m, Curry._2(Z.Nativeint[/* shift_left */30], Z.Nativeint[/* one */2], -e | 0));
    }
  }
}
...
function classify$3(n) {
  if (n[/* den */1] === Z.Nativeint[/* zero */1]) {
    var match = Curry._1(Z.Nativeint[/* sign */47], n[/* num */0]);
    var switcher = match + 1 | 0;
    if (switcher > 2 || switcher < 0) {
      return /* UNDEF */3;
    } else {
...
function sign$3(x) {
  return Curry._1(Z.Nativeint[/* sign */47], x[/* num */0]);
}

function equal$3(x, y) {
  if (Curry._2(Z.Nativeint[/* equal */42], x[/* num */0], y[/* num */0])) {
    return Curry._2(Z.Nativeint[/* equal */42], x[/* den */1], y[/* den */1]);
  } else {
    return false;
  }
}
...
function compare$3(x, y) {
  ...
  if (exit === 1) {
    if (x[/* den */1] === y[/* den */1]) {
      ...
      return Curry._2(Z.Nativeint[/* compare */41], Curry._2(Z.Nativeint[/* mul */18], x[/* num */0], y[/* den */1]), Curry._2(Z.Nativeint[/* mul */18], y[/* num */0], x[/* den */1]));
    }
  }
...
function to_string$3(n) {
  ...
  switch (match) {
    ...
    case 3 : 
        return "undef";
    case 4 : 
        if (Curry._2(Z.Nativeint[/* equal */42], n[/* den */1], Z.Nativeint[/* one */2])) {
...
function to_int$3(x) {
  return Curry._1(Z.Nativeint[/* to_int */33], eval_to_int$3(x));
}

function to_int32$3(x) {
  return Curry._1(Z.Nativeint[/* to_int32 */34], eval_to_int$3(x));
}

function to_int64$3(x) {
  return Curry._1(Z.Nativeint[/* to_int64 */35], eval_to_int$3(x));
}

function to_nativeint$3(x) {
  return Curry._1(Z.Nativeint[/* to_nativeint */36], eval_to_int$3(x));
}

function to_bigint$3(x) {
  return Curry._1(Z.Nativeint[/* to_bigint */37], eval_to_int$3(x));
}
...
function to_float$3(x) {
  ...
  switch (match) {
    ...
    case 4 : 
        var p = x[/* num */0];
        var q = x[/* den */1];
        var np = Curry._1(Z.Nativeint[/* numbits */32], p);
        var nq = Curry._1(Z.Nativeint[/* numbits */32], q);
        if (np <= 53 && nq <= 53) {
          return Caml_int64.to_float(Curry._1(Z.Nativeint[/* to_int64 */35], p)) / Caml_int64.to_float(Curry._1(Z.Nativeint[/* to_int64 */35], q));
        } else {
          var n = 55 - (np - nq | 0) | 0;
          var match$1 = n >= 0 ? /* tuple */[
              Curry._2(Z.Nativeint[/* shift_left */30], p, n),
              q
            ] : /* tuple */[
              p,
              Curry._2(Z.Nativeint[/* shift_left */30], q, -n | 0)
            ];
          var match$2 = Curry._2(Z.Nativeint[/* ediv_rem */22], match$1[0], match$1[1]);
          var f = Curry._2(Z.Nativeint[/* round_to_float */39], match$2[0], Curry._1(Z.Nativeint[/* sign */47], match$2[1]) === 0);
          return Caml_float.caml_ldexp_float(f, -n | 0);
        }
...
function mul$3(x, y) {
  if (x[/* den */1] === Z.Nativeint[/* zero */1] || y[/* den */1] === Z.Nativeint[/* zero */1]) {
    return /* record */[
            /* num */Curry._1(Z.Nativeint[/* of_int */4], Caml_int32.imul(Curry._1(Z.Nativeint[/* sign */47], x[/* num */0]), Curry._1(Z.Nativeint[/* sign */47], y[/* num */0]))),
            /* den */Z.Nativeint[/* zero */1]
          ];
  } else {
...
function inv$3(x) {
  var match = Curry._1(Z.Nativeint[/* sign */47], x[/* num */0]);
  var exit = 0;
  var switcher = match + 1 | 0;
  if (switcher > 2 || switcher < 0) {
    exit = 1;
...
function div$3(x, y) {
  if (Curry._1(Z.Nativeint[/* sign */47], y[/* num */0]) >= 0) {
...
function mul_2exp$3(x, n) {
  if (x[/* den */1] === Z.Nativeint[/* zero */1]) {
    ...
    return make_real$3(Curry._2(Z.Nativeint[/* shift_left */30], x[/* num */0], n), x[/* den */1]);
  }
}
...
function div_2exp$3(x, n) {
  if (x[/* den */1] === Z.Nativeint[/* zero */1]) {
    ...
    return make_real$3(x[/* num */0], Curry._2(Z.Nativeint[/* shift_left */30], x[/* den */1], n));
  }
}
...
function of_float$4(d) {
  if (d === Number.POSITIVE_INFINITY) {
    ...
    if (e >= 0) {
      ...
      return make_real$4(m, Curry._2(Z.Bigint[/* shift_left */30], Z.Bigint[/* one */2], -e | 0));
    }
  }
}
...
function to_int$4(x) {
  return Curry._1(Z.Bigint[/* to_int */33], eval_to_int$4(x));
}

function to_int32$4(x) {
  return Curry._1(Z.Bigint[/* to_int32 */34], eval_to_int$4(x));
}

function to_int64$4(x) {
  return Curry._1(Z.Bigint[/* to_int64 */35], eval_to_int$4(x));
}

function to_nativeint$4(x) {
  return Curry._1(Z.Bigint[/* to_nativeint */36], eval_to_int$4(x));
}

function to_bigint$4(x) {
  return Curry._1(Z.Bigint[/* to_bigint */37], eval_to_int$4(x));
}
...
function mul_2exp$4(x, n) {
  if (x[/* den */1] === Z.Bigint[/* zero */1]) {
    ...
    return make_real$4(Curry._2(Z.Bigint[/* shift_left */30], x[/* num */0], n), x[/* den */1]);
  }
}
...
function div_2exp$4(x, n) {
  if (x[/* den */1] === Z.Bigint[/* zero */1]) {
    ...
    return make_real$4(x[/* num */0], Curry._2(Z.Bigint[/* shift_left */30], x[/* den */1], n));
  }
}
...
function Q(funarg) {
  var make_real = function (n, d) {
    if (n === funarg[/* zero */1] || d === funarg[/* one */2]) {
      ...
      var g = Curry._2(funarg[/* gcd */52], n, d);
      if (g === funarg[/* one */2]) {
        return /* record */[
                /* num */n,
                /* den */d
        ...
        return /* record */[
                /* num */Curry._2(funarg[/* divexact */25], n, g),
                /* den */Curry._2(funarg[/* divexact */25], d, g)
              ];
      }
    }
  };
  var make = function (n, d) {
    var sd = Curry._1(funarg[/* sign */47], d);
    if (sd === 0) {
      return /* record */[
              /* num */Curry._1(funarg[/* of_int */4], Curry._1(funarg[/* sign */47], n)),
              /* den */funarg[/* zero */1]
            ];
    } else if (sd > 0) {
      return make_real(n, d);
  ...
  var of_float = function (d) {
    if (d === Number.POSITIVE_INFINITY) {
      ...
      var e = match[1] - 53 | 0;
      if (e >= 0) {
        var n = Curry._2(funarg[/* shift_left */30], m, e);
        return /* record */[
                /* num */n,
                /* den */funarg[/* one */2]
              ];
      } else {
        return make_real(m, Curry._2(funarg[/* shift_left */30], funarg[/* one */2], -e | 0));
      }
    }
  };
  ...
  var classify = function (n) {
    if (n[/* den */1] === funarg[/* zero */1]) {
      var match = Curry._1(funarg[/* sign */47], n[/* num */0]);
      var switcher = match + 1 | 0;
      if (switcher > 2 || switcher < 0) {
        return /* UNDEF */3;
      } else {
  ...
  var sign = function (x) {
    return Curry._1(funarg[/* sign */47], x[/* num */0]);
  };
  var equal = function (x, y) {
    if (Curry._2(funarg[/* equal */42], x[/* num */0], y[/* num */0])) {
      return Curry._2(funarg[/* equal */42], x[/* den */1], y[/* den */1]);
    } else {
      return false;
    }
  };
  var compare = function (x, y) {
    ...
    if (exit === 1) {
      if (x[/* den */1] === y[/* den */1]) {
        return Curry._2(funarg[/* compare */41], x[/* num */0], y[/* num */0]);
      } else {
        return Curry._2(funarg[/* compare */41], Curry._2(funarg[/* mul */18], x[/* num */0], y[/* den */1]), Curry._2(funarg[/* mul */18], y[/* num */0], x[/* den */1]));
      }
    }
  ...
  var to_string = function (n) {
    ...
    switch (match) {
      ...
      case 3 : 
          return "undef";
      case 4 : 
          if (Curry._2(funarg[/* equal */42], n[/* den */1], funarg[/* one */2])) {
            return Curry._1(funarg[/* to_string */40], n[/* num */0]);
          } else {
            return Curry._1(funarg[/* to_string */40], n[/* num */0]) + ("/" + Curry._1(funarg[/* to_string */40], n[/* den */1]));
          }
  ...
  var to_int = function (x) {
    return Curry._1(funarg[/* to_int */33], eval_to_int(x));
  };
  var to_int32 = function (x) {
    return Curry._1(funarg[/* to_int32 */34], eval_to_int(x));
  };
  var to_int64 = function (x) {
    return Curry._1(funarg[/* to_int64 */35], eval_to_int(x));
  };
  var to_nativeint = function (x) {
    return Curry._1(funarg[/* to_nativeint */36], eval_to_int(x));
  };
  var to_bigint = function (x) {
    return Curry._1(funarg[/* to_bigint */37], eval_to_int(x));
  };
  var to_float = function (x) {
    ...
    switch (match) {
      ...
      case 4 : 
          var p = x[/* num */0];
          var q = x[/* den */1];
          var np = Curry._1(funarg[/* numbits */32], p);
          var nq = Curry._1(funarg[/* numbits */32], q);
          if (np <= 53 && nq <= 53) {
            return Caml_int64.to_float(Curry._1(funarg[/* to_int64 */35], p)) / Caml_int64.to_float(Curry._1(funarg[/* to_int64 */35], q));
          } else {
            var n = 55 - (np - nq | 0) | 0;
            var match$1 = n >= 0 ? /* tuple */[
                Curry._2(funarg[/* shift_left */30], p, n),
                q
              ] : /* tuple */[
                p,
                Curry._2(funarg[/* shift_left */30], q, -n | 0)
              ];
            var match$2 = Curry._2(funarg[/* ediv_rem */22], match$1[0], match$1[1]);
            var f = Curry._2(funarg[/* round_to_float */39], match$2[0], Curry._1(funarg[/* sign */47], match$2[1]) === 0);
            return Caml_float.caml_ldexp_float(f, -n | 0);
          }
  ...
  var mul = function (x, y) {
    if (x[/* den */1] === funarg[/* zero */1] || y[/* den */1] === funarg[/* zero */1]) {
      return /* record */[
              /* num */Curry._1(funarg[/* of_int */4], Caml_int32.imul(Curry._1(funarg[/* sign */47], x[/* num */0]), Curry._1(funarg[/* sign */47], y[/* num */0]))),
              /* den */funarg[/* zero */1]
            ];
    } else {
  ...
  var inv = function (x) {
    var match = Curry._1(funarg[/* sign */47], x[/* num */0]);
    var exit = 0;
    var switcher = match + 1 | 0;
    if (switcher > 2 || switcher < 0) {
      exit = 1;
  ...
  var div = function (x, y) {
    if (Curry._1(funarg[/* sign */47], y[/* num */0]) >= 0) {
      return mul(x, /* record */[
                  /* num */y[/* den */1],
                  /* den */y[/* num */0]
                ]);
  ...
  var mul_2exp = function (x, n) {
    if (x[/* den */1] === funarg[/* zero */1]) {
      ...
      return make_real(Curry._2(funarg[/* shift_left */30], x[/* num */0], n), x[/* den */1]);
    }
  };
  var div_2exp = function (x, n) {
    if (x[/* den */1] === funarg[/* zero */1]) {
      ...
      return make_real(x[/* num */0], Curry._2(funarg[/* shift_left */30], x[/* den */1], n));
    }
  };
