...
function make_real(n, d) {
  if (n === Z.Int[/* zero */1] || d === Z.Int[/* one */2]) {
    ...
    var g = Curry._2(Z.Int[/* gcd */50], n, d);
    if (g === Z.Int[/* one */2]) {
      return /* record */[
              /* num */n,
              /* den */d
      ...
      return /* record */[
              /* num */Curry._2(Z.Int[/* divexact */24], n, g),
              /* den */Curry._2(Z.Int[/* divexact */24], d, g)
            ];
    }
  }
}
...
function make(n, d) {
  var sd = Curry._1(Z.Int[/* sign */45], d);
  if (sd === 0) {
    return /* record */[
            /* num */Curry._1(Z.Int[/* of_int */4], Curry._1(Z.Int[/* sign */45], n)),
            /* den */Z.Int[/* zero */1]
          ];
  } else if (sd > 0) {
    return make_real(n, d);
  } else {
    return make_real(Curry._1(Z.Int[/* neg */14], n), Curry._1(Z.Int[/* neg */14], d));
  }
}
...
function of_float(d) {
  if (d === Number.POSITIVE_INFINITY) {
    ...
    var m = Curry._1(Z.Int[/* of_float */8], Caml_float.caml_ldexp_float(match[0], 53));
    var e = match[1] - 53 | 0;
    if (e >= 0) {
      var n = Curry._2(Z.Int[/* shift_left */29], m, e);
      return /* record */[
              /* num */n,
              /* den */Z.Int[/* one */2]
            ];
    } else {
      return make_real(m, Curry._2(Z.Int[/* shift_left */29], Z.Int[/* one */2], -e | 0));
    }
  }
}
...
function of_string(s) {
  try {
    ...
    return make(Curry._3(Z.Int[/* of_substring */10], s, 0, i), Curry._3(Z.Int[/* of_substring */10], s, i + 1 | 0, (s.length - i | 0) - 1 | 0));
  }
  catch (exn){
    if (exn === Caml_builtin_exceptions.not_found) {
      if (s === "inf" || s === "+inf") {
        ...
        var n = Curry._1(Z.Int[/* of_string */9], s);
        return /* record */[
                /* num */n,
                /* den */Z.Int[/* one */2]
              ];
...
function classify(n) {
  if (n[/* den */1] === Z.Int[/* zero */1]) {
    var match = Curry._1(Z.Int[/* sign */45], n[/* num */0]);
...
function sign(x) {
  return Curry._1(Z.Int[/* sign */45], x[/* num */0]);
}

function equal(x, y) {
  if (Curry._2(Z.Int[/* equal */40], x[/* num */0], y[/* num */0])) {
    return Curry._2(Z.Int[/* equal */40], x[/* den */1], y[/* den */1]);
  } else {
    return false;
  }
}
...
function compare(x, y) {
  ...
  if (exit === 1) {
    if (x[/* den */1] === y[/* den */1]) {
      return Curry._2(Z.Int[/* compare */39], x[/* num */0], y[/* num */0]);
    } else {
      return Curry._2(Z.Int[/* compare */39], Curry._2(Z.Int[/* mul */17], x[/* num */0], y[/* den */1]), Curry._2(Z.Int[/* mul */17], y[/* num */0], x[/* den */1]));
    }
  }
...
function to_string(n) {
  ...
  switch (match) {
    ...
    case 3 : 
        return "undef";
    case 4 : 
        if (Curry._2(Z.Int[/* equal */40], n[/* den */1], Z.Int[/* one */2])) {
          return Curry._1(Z.Int[/* to_string */38], n[/* num */0]);
        } else {
          return Curry._1(Z.Int[/* to_string */38], n[/* num */0]) + ("/" + Curry._1(Z.Int[/* to_string */38], n[/* den */1]));
        }
...
function to_bigint(x) {
  return Curry._2(Z.Int[/* div */18], x[/* num */0], x[/* den */1]);
}

function to_int(x) {
  return Curry._1(Z.Int[/* to_int */32], to_bigint(x));
}

function to_int32(x) {
  return Curry._1(Z.Int[/* to_int32 */33], to_bigint(x));
}

function to_int64(x) {
  return Curry._1(Z.Int[/* to_int64 */34], to_bigint(x));
}

function to_nativeint(x) {
  return Curry._1(Z.Int[/* to_nativeint */35], to_bigint(x));
}
...
function to_float(x) {
  ...
  switch (match) {
    ...
    case 4 : 
        var p = x[/* num */0];
        var q = x[/* den */1];
        var np = Curry._1(Z.Int[/* numbits */31], p);
        var nq = Curry._1(Z.Int[/* numbits */31], q);
        if (np <= 53 && nq <= 53) {
          return Caml_int64.to_float(Curry._1(Z.Int[/* to_int64 */34], p)) / Caml_int64.to_float(Curry._1(Z.Int[/* to_int64 */34], q));
        } else {
          var n = 55 - (np - nq | 0) | 0;
          var match$1 = n >= 0 ? /* tuple */[
              Curry._2(Z.Int[/* shift_left */29], p, n),
              q
            ] : /* tuple */[
              p,
              Curry._2(Z.Int[/* shift_left */29], q, -n | 0)
            ];
          var match$2 = Curry._2(Z.Int[/* ediv_rem */21], match$1[0], match$1[1]);
          var f = Curry._2(Z.Int[/* round_to_float */37], match$2[0], Curry._1(Z.Int[/* sign */45], match$2[1]) === 0);
...
function neg(x) {
  return /* record */[
          /* num */Curry._1(Z.Int[/* neg */14], x[/* num */0]),
          /* den */x[/* den */1]
        ];
}
...
function abs(x) {
  return /* record */[
          /* num */Curry._1(Z.Int[/* abs */13], x[/* num */0]),
          /* den */x[/* den */1]
        ];
}
...
function aors(zaors, x, y) {
  if (x[/* den */1] === y[/* den */1]) {
    ...
    return make_real(Curry._2(zaors, Curry._2(Z.Int[/* mul */17], x[/* num */0], y[/* den */1]), Curry._2(Z.Int[/* mul */17], y[/* num */0], x[/* den */1])), Curry._2(Z.Int[/* mul */17], x[/* den */1], y[/* den */1]));
  }
}
...
function mul(x, y) {
  if (x[/* den */1] === Z.Int[/* zero */1] || y[/* den */1] === Z.Int[/* zero */1]) {
    return /* record */[
            /* num */Curry._1(Z.Int[/* of_int */4], Caml_int32.imul(Curry._1(Z.Int[/* sign */45], x[/* num */0]), Curry._1(Z.Int[/* sign */45], y[/* num */0]))),
            /* den */Z.Int[/* zero */1]
          ];
  } else {
    return make_real(Curry._2(Z.Int[/* mul */17], x[/* num */0], y[/* num */0]), Curry._2(Z.Int[/* mul */17], x[/* den */1], y[/* den */1]));
  }
}

function inv(x) {
  var match = Curry._1(Z.Int[/* sign */45], x[/* num */0]);
  var exit = 0;
  var switcher = match + 1 | 0;
  if (switcher > 2 || switcher < 0) {
    exit = 1;
    ...
    switch (switcher) {
      case 0 : 
          return /* record */[
                  /* num */Curry._1(Z.Int[/* neg */14], x[/* den */1]),
                  /* den */Curry._1(Z.Int[/* neg */14], x[/* num */0])
                ];
      case 1 : 
          exit = 1;
          break;
...
function div(x, y) {
  if (Curry._1(Z.Int[/* sign */45], y[/* num */0]) >= 0) {
    return mul(x, /* record */[
                /* num */y[/* den */1],
                /* den */y[/* num */0]
              ]);
    ...
    return mul(x, /* record */[
                /* num */Curry._1(Z.Int[/* neg */14], y[/* den */1]),
                /* den */Curry._1(Z.Int[/* neg */14], y[/* num */0])
              ]);
  }
}
...
function mul_2exp(x, n) {
  if (x[/* den */1] === Z.Int[/* zero */1]) {
    ...
    return make_real(Curry._2(Z.Int[/* shift_left */29], x[/* num */0], n), x[/* den */1]);
  }
}
...
function div_2exp(x, n) {
  if (x[/* den */1] === Z.Int[/* zero */1]) {
    ...
    return make_real(x[/* num */0], Curry._2(Z.Int[/* shift_left */29], x[/* den */1], n));
  }
}
...
function make_real$1(n, d) {
  if (n === Z.Int32[/* zero */1] || d === Z.Int32[/* one */2]) {
    ...
    var g = Curry._2(Z.Int32[/* gcd */50], n, d);
    if (g === Z.Int32[/* one */2]) {
      return /* record */[
              /* num */n,
              /* den */d
      ...
      return /* record */[
              /* num */Curry._2(Z.Int32[/* divexact */24], n, g),
              /* den */Curry._2(Z.Int32[/* divexact */24], d, g)
            ];
    }
  }
}
...
function make$1(n, d) {
  var sd = Curry._1(Z.Int32[/* sign */45], d);
  if (sd === 0) {
    return /* record */[
            /* num */Curry._1(Z.Int32[/* of_int */4], Curry._1(Z.Int32[/* sign */45], n)),
            /* den */Z.Int32[/* zero */1]
          ];
  } else if (sd > 0) {
    return make_real$1(n, d);
  } else {
    return make_real$1(Curry._1(Z.Int32[/* neg */14], n), Curry._1(Z.Int32[/* neg */14], d));
  }
}
...
function of_float$1(d) {
  if (d === Number.POSITIVE_INFINITY) {
    ...
    var match = Caml_float.caml_frexp_float(d);
    var m = Curry._1(Z.Int32[/* of_float */8], Caml_float.caml_ldexp_float(match[0], 53));
    var e = match[1] - 53 | 0;
    if (e >= 0) {
      var n = Curry._2(Z.Int32[/* shift_left */29], m, e);
      return /* record */[
              /* num */n,
              /* den */Z.Int32[/* one */2]
            ];
    } else {
      return make_real$1(m, Curry._2(Z.Int32[/* shift_left */29], Z.Int32[/* one */2], -e | 0));
    }
  }
}
...
function of_string$1(s) {
  try {
    var i = $$String.index(s, /* "/" */47);
    return make$1(Curry._3(Z.Int32[/* of_substring */10], s, 0, i), Curry._3(Z.Int32[/* of_substring */10], s, i + 1 | 0, (s.length - i | 0) - 1 | 0));
  }
  catch (exn){
    if (exn === Caml_builtin_exceptions.not_found) {
      if (s === "inf" || s === "+inf") {
        ...
        var n = Curry._1(Z.Int32[/* of_string */9], s);
        return /* record */[
                /* num */n,
                /* den */Z.Int32[/* one */2]
              ];
...
function classify$1(n) {
  if (n[/* den */1] === Z.Int32[/* zero */1]) {
    var match = Curry._1(Z.Int32[/* sign */45], n[/* num */0]);
    var switcher = match + 1 | 0;
    if (switcher > 2 || switcher < 0) {
      return /* UNDEF */3;
    } else {
...
function sign$1(x) {
  return Curry._1(Z.Int32[/* sign */45], x[/* num */0]);
}

function equal$1(x, y) {
  if (Curry._2(Z.Int32[/* equal */40], x[/* num */0], y[/* num */0])) {
    return Curry._2(Z.Int32[/* equal */40], x[/* den */1], y[/* den */1]);
  } else {
    return false;
  }
}
...
function compare$1(x, y) {
  ...
  if (exit === 1) {
    if (x[/* den */1] === y[/* den */1]) {
      return Curry._2(Z.Int32[/* compare */39], x[/* num */0], y[/* num */0]);
    } else {
      return Curry._2(Z.Int32[/* compare */39], Curry._2(Z.Int32[/* mul */17], x[/* num */0], y[/* den */1]), Curry._2(Z.Int32[/* mul */17], y[/* num */0], x[/* den */1]));
    }
  }
...
function to_string$1(n) {
  ...
  switch (match) {
    ...
    case 3 : 
        return "undef";
    case 4 : 
        if (Curry._2(Z.Int32[/* equal */40], n[/* den */1], Z.Int32[/* one */2])) {
          return Curry._1(Z.Int32[/* to_string */38], n[/* num */0]);
        } else {
          return Curry._1(Z.Int32[/* to_string */38], n[/* num */0]) + ("/" + Curry._1(Z.Int32[/* to_string */38], n[/* den */1]));
        }
...
function to_bigint$1(x) {
  return Curry._2(Z.Int32[/* div */18], x[/* num */0], x[/* den */1]);
}

function to_int$1(x) {
  return Curry._1(Z.Int32[/* to_int */32], to_bigint$1(x));
}

function to_int32$1(x) {
  return Curry._1(Z.Int32[/* to_int32 */33], to_bigint$1(x));
}

function to_int64$1(x) {
  return Curry._1(Z.Int32[/* to_int64 */34], to_bigint$1(x));
}

function to_nativeint$1(x) {
  return Curry._1(Z.Int32[/* to_nativeint */35], to_bigint$1(x));
}
...
function to_float$1(x) {
  ...
  switch (match) {
    ...
    case 4 : 
        var p = x[/* num */0];
        var q = x[/* den */1];
        var np = Curry._1(Z.Int32[/* numbits */31], p);
        var nq = Curry._1(Z.Int32[/* numbits */31], q);
        if (np <= 53 && nq <= 53) {
          return Caml_int64.to_float(Curry._1(Z.Int32[/* to_int64 */34], p)) / Caml_int64.to_float(Curry._1(Z.Int32[/* to_int64 */34], q));
        } else {
          var n = 55 - (np - nq | 0) | 0;
          var match$1 = n >= 0 ? /* tuple */[
              Curry._2(Z.Int32[/* shift_left */29], p, n),
              q
            ] : /* tuple */[
              p,
              Curry._2(Z.Int32[/* shift_left */29], q, -n | 0)
            ];
          var match$2 = Curry._2(Z.Int32[/* ediv_rem */21], match$1[0], match$1[1]);
          var f = Curry._2(Z.Int32[/* round_to_float */37], match$2[0], Curry._1(Z.Int32[/* sign */45], match$2[1]) === 0);
          return Caml_float.caml_ldexp_float(f, -n | 0);
        }
...
function neg$1(x) {
  return /* record */[
          /* num */Curry._1(Z.Int32[/* neg */14], x[/* num */0]),
          /* den */x[/* den */1]
        ];
}
...
function abs$1(x) {
  return /* record */[
          /* num */Curry._1(Z.Int32[/* abs */13], x[/* num */0]),
          /* den */x[/* den */1]
        ];
}
...
function aors$1(zaors, x, y) {
  if (x[/* den */1] === y[/* den */1]) {
    ...
    return make_real$1(Curry._2(zaors, Curry._2(Z.Int32[/* mul */17], x[/* num */0], y[/* den */1]), Curry._2(Z.Int32[/* mul */17], y[/* num */0], x[/* den */1])), Curry._2(Z.Int32[/* mul */17], x[/* den */1], y[/* den */1]));
  }
}
...
function add$1(x, y) {
  if (x[/* den */1] === Z.Int32[/* zero */1] || y[/* den */1] === Z.Int32[/* zero */1]) {
    ...
    return aors$1(Z.Int32[/* add */15], x, y);
  }
}
...
function sub$1(x, y) {
  if (x[/* den */1] === Z.Int32[/* zero */1] || y[/* den */1] === Z.Int32[/* zero */1]) {
    ...
    return aors$1(Z.Int32[/* sub */16], x, y);
  }
}
...
function mul$1(x, y) {
  if (x[/* den */1] === Z.Int32[/* zero */1] || y[/* den */1] === Z.Int32[/* zero */1]) {
    return /* record */[
            /* num */Curry._1(Z.Int32[/* of_int */4], Caml_int32.imul(Curry._1(Z.Int32[/* sign */45], x[/* num */0]), Curry._1(Z.Int32[/* sign */45], y[/* num */0]))),
            /* den */Z.Int32[/* zero */1]
          ];
  } else {
    return make_real$1(Curry._2(Z.Int32[/* mul */17], x[/* num */0], y[/* num */0]), Curry._2(Z.Int32[/* mul */17], x[/* den */1], y[/* den */1]));
  }
}

function inv$1(x) {
  var match = Curry._1(Z.Int32[/* sign */45], x[/* num */0]);
  var exit = 0;
  var switcher = match + 1 | 0;
  if (switcher > 2 || switcher < 0) {
    exit = 1;
    ...
    switch (switcher) {
      case 0 : 
          return /* record */[
                  /* num */Curry._1(Z.Int32[/* neg */14], x[/* den */1]),
                  /* den */Curry._1(Z.Int32[/* neg */14], x[/* num */0])
                ];
      case 1 : 
          exit = 1;
          break;
...
function div$1(x, y) {
  if (Curry._1(Z.Int32[/* sign */45], y[/* num */0]) >= 0) {
    ...
    return mul$1(x, /* record */[
                /* num */Curry._1(Z.Int32[/* neg */14], y[/* den */1]),
                /* den */Curry._1(Z.Int32[/* neg */14], y[/* num */0])
              ]);
  }
}
...
function mul_2exp$1(x, n) {
  if (x[/* den */1] === Z.Int32[/* zero */1]) {
    ...
    return make_real$1(Curry._2(Z.Int32[/* shift_left */29], x[/* num */0], n), x[/* den */1]);
  }
}
...
function div_2exp$1(x, n) {
  if (x[/* den */1] === Z.Int32[/* zero */1]) {
    ...
    return make_real$1(x[/* num */0], Curry._2(Z.Int32[/* shift_left */29], x[/* den */1], n));
  }
}
...
function make_real$2(n, d) {
  if (n === Z.Int64[/* zero */1] || d === Z.Int64[/* one */2]) {
    ...
    var g = Curry._2(Z.Int64[/* gcd */50], n, d);
    if (g === Z.Int64[/* one */2]) {
      return /* record */[
              /* num */n,
              /* den */d
      ...
      return /* record */[
              /* num */Curry._2(Z.Int64[/* divexact */24], n, g),
              /* den */Curry._2(Z.Int64[/* divexact */24], d, g)
            ];
    }
  }
}
...
function make$2(n, d) {
  var sd = Curry._1(Z.Int64[/* sign */45], d);
  if (sd === 0) {
    return /* record */[
            /* num */Curry._1(Z.Int64[/* of_int */4], Curry._1(Z.Int64[/* sign */45], n)),
            /* den */Z.Int64[/* zero */1]
          ];
  } else if (sd > 0) {
    return make_real$2(n, d);
  } else {
    return make_real$2(Curry._1(Z.Int64[/* neg */14], n), Curry._1(Z.Int64[/* neg */14], d));
  }
}
...
function of_float$2(d) {
  if (d === Number.POSITIVE_INFINITY) {
    ...
    var match = Caml_float.caml_frexp_float(d);
    var m = Curry._1(Z.Int64[/* of_float */8], Caml_float.caml_ldexp_float(match[0], 53));
    var e = match[1] - 53 | 0;
    if (e >= 0) {
      var n = Curry._2(Z.Int64[/* shift_left */29], m, e);
      return /* record */[
              /* num */n,
              /* den */Z.Int64[/* one */2]
            ];
    } else {
      return make_real$2(m, Curry._2(Z.Int64[/* shift_left */29], Z.Int64[/* one */2], -e | 0));
    }
  }
}
...
function of_string$2(s) {
  try {
    var i = $$String.index(s, /* "/" */47);
    return make$2(Curry._3(Z.Int64[/* of_substring */10], s, 0, i), Curry._3(Z.Int64[/* of_substring */10], s, i + 1 | 0, (s.length - i | 0) - 1 | 0));
  }
  catch (exn){
    if (exn === Caml_builtin_exceptions.not_found) {
      if (s === "inf" || s === "+inf") {
        ...
        var n = Curry._1(Z.Int64[/* of_string */9], s);
        return /* record */[
                /* num */n,
                /* den */Z.Int64[/* one */2]
              ];
...
function classify$2(n) {
  if (n[/* den */1] === Z.Int64[/* zero */1]) {
    var match = Curry._1(Z.Int64[/* sign */45], n[/* num */0]);
    var switcher = match + 1 | 0;
    if (switcher > 2 || switcher < 0) {
      return /* UNDEF */3;
    } else {
...
function sign$2(x) {
  return Curry._1(Z.Int64[/* sign */45], x[/* num */0]);
}

function equal$2(x, y) {
  if (Curry._2(Z.Int64[/* equal */40], x[/* num */0], y[/* num */0])) {
    return Curry._2(Z.Int64[/* equal */40], x[/* den */1], y[/* den */1]);
  } else {
    return false;
  }
}
...
function compare$2(x, y) {
  ...
  if (exit === 1) {
    if (x[/* den */1] === y[/* den */1]) {
      return Curry._2(Z.Int64[/* compare */39], x[/* num */0], y[/* num */0]);
    } else {
      return Curry._2(Z.Int64[/* compare */39], Curry._2(Z.Int64[/* mul */17], x[/* num */0], y[/* den */1]), Curry._2(Z.Int64[/* mul */17], y[/* num */0], x[/* den */1]));
    }
  }
...
function to_string$2(n) {
  ...
  switch (match) {
    ...
    case 3 : 
        return "undef";
    case 4 : 
        if (Curry._2(Z.Int64[/* equal */40], n[/* den */1], Z.Int64[/* one */2])) {
          return Curry._1(Z.Int64[/* to_string */38], n[/* num */0]);
        } else {
          return Curry._1(Z.Int64[/* to_string */38], n[/* num */0]) + ("/" + Curry._1(Z.Int64[/* to_string */38], n[/* den */1]));
        }
...
function to_bigint$2(x) {
  return Curry._2(Z.Int64[/* div */18], x[/* num */0], x[/* den */1]);
}

function to_int$2(x) {
  return Curry._1(Z.Int64[/* to_int */32], to_bigint$2(x));
}

function to_int32$2(x) {
  return Curry._1(Z.Int64[/* to_int32 */33], to_bigint$2(x));
}

function to_int64$2(x) {
  return Curry._1(Z.Int64[/* to_int64 */34], to_bigint$2(x));
}

function to_nativeint$2(x) {
  return Curry._1(Z.Int64[/* to_nativeint */35], to_bigint$2(x));
}
...
function to_float$2(x) {
  ...
  switch (match) {
    ...
    case 4 : 
        var p = x[/* num */0];
        var q = x[/* den */1];
        var np = Curry._1(Z.Int64[/* numbits */31], p);
        var nq = Curry._1(Z.Int64[/* numbits */31], q);
        if (np <= 53 && nq <= 53) {
          return Caml_int64.to_float(Curry._1(Z.Int64[/* to_int64 */34], p)) / Caml_int64.to_float(Curry._1(Z.Int64[/* to_int64 */34], q));
        } else {
          var n = 55 - (np - nq | 0) | 0;
          var match$1 = n >= 0 ? /* tuple */[
              Curry._2(Z.Int64[/* shift_left */29], p, n),
              q
            ] : /* tuple */[
              p,
              Curry._2(Z.Int64[/* shift_left */29], q, -n | 0)
            ];
          var match$2 = Curry._2(Z.Int64[/* ediv_rem */21], match$1[0], match$1[1]);
          var f = Curry._2(Z.Int64[/* round_to_float */37], match$2[0], Curry._1(Z.Int64[/* sign */45], match$2[1]) === 0);
          return Caml_float.caml_ldexp_float(f, -n | 0);
        }
...
function neg$2(x) {
  return /* record */[
          /* num */Curry._1(Z.Int64[/* neg */14], x[/* num */0]),
          /* den */x[/* den */1]
        ];
}
...
function abs$2(x) {
  return /* record */[
          /* num */Curry._1(Z.Int64[/* abs */13], x[/* num */0]),
          /* den */x[/* den */1]
        ];
}
...
function aors$2(zaors, x, y) {
  if (x[/* den */1] === y[/* den */1]) {
    ...
    return make_real$2(Curry._2(zaors, Curry._2(Z.Int64[/* mul */17], x[/* num */0], y[/* den */1]), Curry._2(Z.Int64[/* mul */17], y[/* num */0], x[/* den */1])), Curry._2(Z.Int64[/* mul */17], x[/* den */1], y[/* den */1]));
  }
}
...
function add$2(x, y) {
  if (x[/* den */1] === Z.Int64[/* zero */1] || y[/* den */1] === Z.Int64[/* zero */1]) {
    ...
    return aors$2(Z.Int64[/* add */15], x, y);
  }
}
...
function sub$2(x, y) {
  if (x[/* den */1] === Z.Int64[/* zero */1] || y[/* den */1] === Z.Int64[/* zero */1]) {
    ...
    return aors$2(Z.Int64[/* sub */16], x, y);
  }
}
...
function mul$2(x, y) {
  if (x[/* den */1] === Z.Int64[/* zero */1] || y[/* den */1] === Z.Int64[/* zero */1]) {
    return /* record */[
            /* num */Curry._1(Z.Int64[/* of_int */4], Caml_int32.imul(Curry._1(Z.Int64[/* sign */45], x[/* num */0]), Curry._1(Z.Int64[/* sign */45], y[/* num */0]))),
            /* den */Z.Int64[/* zero */1]
          ];
  } else {
    return make_real$2(Curry._2(Z.Int64[/* mul */17], x[/* num */0], y[/* num */0]), Curry._2(Z.Int64[/* mul */17], x[/* den */1], y[/* den */1]));
  }
}

function inv$2(x) {
  var match = Curry._1(Z.Int64[/* sign */45], x[/* num */0]);
  var exit = 0;
  var switcher = match + 1 | 0;
  if (switcher > 2 || switcher < 0) {
    exit = 1;
    ...
    switch (switcher) {
      case 0 : 
          return /* record */[
                  /* num */Curry._1(Z.Int64[/* neg */14], x[/* den */1]),
                  /* den */Curry._1(Z.Int64[/* neg */14], x[/* num */0])
                ];
      case 1 : 
          exit = 1;
          break;
...
function div$2(x, y) {
  if (Curry._1(Z.Int64[/* sign */45], y[/* num */0]) >= 0) {
    ...
    return mul$2(x, /* record */[
                /* num */Curry._1(Z.Int64[/* neg */14], y[/* den */1]),
                /* den */Curry._1(Z.Int64[/* neg */14], y[/* num */0])
              ]);
  }
}
...
function mul_2exp$2(x, n) {
  if (x[/* den */1] === Z.Int64[/* zero */1]) {
    ...
    return make_real$2(Curry._2(Z.Int64[/* shift_left */29], x[/* num */0], n), x[/* den */1]);
  }
}
...
function div_2exp$2(x, n) {
  if (x[/* den */1] === Z.Int64[/* zero */1]) {
    ...
    return make_real$2(x[/* num */0], Curry._2(Z.Int64[/* shift_left */29], x[/* den */1], n));
  }
}
...
function make_real$3(n, d) {
  if (n === Z.Nativeint[/* zero */1] || d === Z.Nativeint[/* one */2]) {
    ...
    var g = Curry._2(Z.Nativeint[/* gcd */50], n, d);
    if (g === Z.Nativeint[/* one */2]) {
      ...
      return /* record */[
              /* num */Curry._2(Z.Nativeint[/* divexact */24], n, g),
              /* den */Curry._2(Z.Nativeint[/* divexact */24], d, g)
            ];
    }
  }
}
...
function make$3(n, d) {
  var sd = Curry._1(Z.Nativeint[/* sign */45], d);
  if (sd === 0) {
    return /* record */[
            /* num */Curry._1(Z.Nativeint[/* of_int */4], Curry._1(Z.Nativeint[/* sign */45], n)),
            /* den */Z.Nativeint[/* zero */1]
          ];
  } else if (sd > 0) {
    return make_real$3(n, d);
  } else {
    return make_real$3(Curry._1(Z.Nativeint[/* neg */14], n), Curry._1(Z.Nativeint[/* neg */14], d));
  }
}
...
function of_float$3(d) {
  if (d === Number.POSITIVE_INFINITY) {
    ...
    var match = Caml_float.caml_frexp_float(d);
    var m = Curry._1(Z.Nativeint[/* of_float */8], Caml_float.caml_ldexp_float(match[0], 53));
    var e = match[1] - 53 | 0;
    if (e >= 0) {
      var n = Curry._2(Z.Nativeint[/* shift_left */29], m, e);
      return /* record */[
              /* num */n,
              /* den */Z.Nativeint[/* one */2]
            ];
    } else {
      return make_real$3(m, Curry._2(Z.Nativeint[/* shift_left */29], Z.Nativeint[/* one */2], -e | 0));
    }
  }
}
...
function of_string$3(s) {
  try {
    var i = $$String.index(s, /* "/" */47);
    return make$3(Curry._3(Z.Nativeint[/* of_substring */10], s, 0, i), Curry._3(Z.Nativeint[/* of_substring */10], s, i + 1 | 0, (s.length - i | 0) - 1 | 0));
  }
  catch (exn){
    if (exn === Caml_builtin_exceptions.not_found) {
      if (s === "inf" || s === "+inf") {
        ...
        var n = Curry._1(Z.Nativeint[/* of_string */9], s);
        return /* record */[
                /* num */n,
                /* den */Z.Nativeint[/* one */2]
              ];
...
function classify$3(n) {
  if (n[/* den */1] === Z.Nativeint[/* zero */1]) {
    var match = Curry._1(Z.Nativeint[/* sign */45], n[/* num */0]);
    var switcher = match + 1 | 0;
    if (switcher > 2 || switcher < 0) {
      return /* UNDEF */3;
    } else {
...
function sign$3(x) {
  return Curry._1(Z.Nativeint[/* sign */45], x[/* num */0]);
}

function equal$3(x, y) {
  if (Curry._2(Z.Nativeint[/* equal */40], x[/* num */0], y[/* num */0])) {
    return Curry._2(Z.Nativeint[/* equal */40], x[/* den */1], y[/* den */1]);
  } else {
    return false;
  }
}
...
function compare$3(x, y) {
  ...
  if (exit === 1) {
    if (x[/* den */1] === y[/* den */1]) {
      return Curry._2(Z.Nativeint[/* compare */39], x[/* num */0], y[/* num */0]);
    } else {
      return Curry._2(Z.Nativeint[/* compare */39], Curry._2(Z.Nativeint[/* mul */17], x[/* num */0], y[/* den */1]), Curry._2(Z.Nativeint[/* mul */17], y[/* num */0], x[/* den */1]));
    }
  }
...
function to_string$3(n) {
  ...
  switch (match) {
    ...
    case 3 : 
        return "undef";
    case 4 : 
        if (Curry._2(Z.Nativeint[/* equal */40], n[/* den */1], Z.Nativeint[/* one */2])) {
          return Curry._1(Z.Nativeint[/* to_string */38], n[/* num */0]);
        } else {
          return Curry._1(Z.Nativeint[/* to_string */38], n[/* num */0]) + ("/" + Curry._1(Z.Nativeint[/* to_string */38], n[/* den */1]));
        }
...
function to_bigint$3(x) {
  return Curry._2(Z.Nativeint[/* div */18], x[/* num */0], x[/* den */1]);
}

function to_int$3(x) {
  return Curry._1(Z.Nativeint[/* to_int */32], to_bigint$3(x));
}

function to_int32$3(x) {
  return Curry._1(Z.Nativeint[/* to_int32 */33], to_bigint$3(x));
}

function to_int64$3(x) {
  return Curry._1(Z.Nativeint[/* to_int64 */34], to_bigint$3(x));
}

function to_nativeint$3(x) {
  return Curry._1(Z.Nativeint[/* to_nativeint */35], to_bigint$3(x));
}
...
function to_float$3(x) {
  ...
  switch (match) {
    ...
    case 4 : 
        var p = x[/* num */0];
        var q = x[/* den */1];
        var np = Curry._1(Z.Nativeint[/* numbits */31], p);
        var nq = Curry._1(Z.Nativeint[/* numbits */31], q);
        if (np <= 53 && nq <= 53) {
          return Caml_int64.to_float(Curry._1(Z.Nativeint[/* to_int64 */34], p)) / Caml_int64.to_float(Curry._1(Z.Nativeint[/* to_int64 */34], q));
        } else {
          var n = 55 - (np - nq | 0) | 0;
          var match$1 = n >= 0 ? /* tuple */[
              Curry._2(Z.Nativeint[/* shift_left */29], p, n),
              q
            ] : /* tuple */[
              p,
              Curry._2(Z.Nativeint[/* shift_left */29], q, -n | 0)
            ];
          var match$2 = Curry._2(Z.Nativeint[/* ediv_rem */21], match$1[0], match$1[1]);
          var f = Curry._2(Z.Nativeint[/* round_to_float */37], match$2[0], Curry._1(Z.Nativeint[/* sign */45], match$2[1]) === 0);
          return Caml_float.caml_ldexp_float(f, -n | 0);
        }
...
function neg$3(x) {
  return /* record */[
          /* num */Curry._1(Z.Nativeint[/* neg */14], x[/* num */0]),
          /* den */x[/* den */1]
        ];
}
...
function abs$3(x) {
  return /* record */[
          /* num */Curry._1(Z.Nativeint[/* abs */13], x[/* num */0]),
          /* den */x[/* den */1]
        ];
}
...
function aors$3(zaors, x, y) {
  if (x[/* den */1] === y[/* den */1]) {
    ...
    return make_real$3(Curry._2(zaors, Curry._2(Z.Nativeint[/* mul */17], x[/* num */0], y[/* den */1]), Curry._2(Z.Nativeint[/* mul */17], y[/* num */0], x[/* den */1])), Curry._2(Z.Nativeint[/* mul */17], x[/* den */1], y[/* den */1]));
  }
}
...
function add$3(x, y) {
  if (x[/* den */1] === Z.Nativeint[/* zero */1] || y[/* den */1] === Z.Nativeint[/* zero */1]) {
    ...
    return aors$3(Z.Nativeint[/* add */15], x, y);
  }
}
...
function sub$3(x, y) {
  if (x[/* den */1] === Z.Nativeint[/* zero */1] || y[/* den */1] === Z.Nativeint[/* zero */1]) {
    ...
    return aors$3(Z.Nativeint[/* sub */16], x, y);
  }
}
...
function mul$3(x, y) {
  if (x[/* den */1] === Z.Nativeint[/* zero */1] || y[/* den */1] === Z.Nativeint[/* zero */1]) {
    return /* record */[
            /* num */Curry._1(Z.Nativeint[/* of_int */4], Caml_int32.imul(Curry._1(Z.Nativeint[/* sign */45], x[/* num */0]), Curry._1(Z.Nativeint[/* sign */45], y[/* num */0]))),
            /* den */Z.Nativeint[/* zero */1]
          ];
  } else {
    return make_real$3(Curry._2(Z.Nativeint[/* mul */17], x[/* num */0], y[/* num */0]), Curry._2(Z.Nativeint[/* mul */17], x[/* den */1], y[/* den */1]));
  }
}

function inv$3(x) {
  var match = Curry._1(Z.Nativeint[/* sign */45], x[/* num */0]);
  var exit = 0;
  var switcher = match + 1 | 0;
  if (switcher > 2 || switcher < 0) {
    exit = 1;
    ...
    switch (switcher) {
      case 0 : 
          return /* record */[
                  /* num */Curry._1(Z.Nativeint[/* neg */14], x[/* den */1]),
                  /* den */Curry._1(Z.Nativeint[/* neg */14], x[/* num */0])
                ];
      case 1 : 
          exit = 1;
          break;
...
function div$3(x, y) {
  if (Curry._1(Z.Nativeint[/* sign */45], y[/* num */0]) >= 0) {
    ...
    return mul$3(x, /* record */[
                /* num */Curry._1(Z.Nativeint[/* neg */14], y[/* den */1]),
                /* den */Curry._1(Z.Nativeint[/* neg */14], y[/* num */0])
              ]);
  }
}
...
function mul_2exp$3(x, n) {
  if (x[/* den */1] === Z.Nativeint[/* zero */1]) {
    ...
    return make_real$3(Curry._2(Z.Nativeint[/* shift_left */29], x[/* num */0], n), x[/* den */1]);
  }
}
...
function div_2exp$3(x, n) {
  if (x[/* den */1] === Z.Nativeint[/* zero */1]) {
    ...
    return make_real$3(x[/* num */0], Curry._2(Z.Nativeint[/* shift_left */29], x[/* den */1], n));
  }
}
...
function make_real$4(n, d) {
  if (n === Z.Bigint[/* zero */1] || d === Z.Bigint[/* one */2]) {
    ...
    var g = Curry._2(Z.Bigint[/* gcd */50], n, d);
    if (g === Z.Bigint[/* one */2]) {
      return /* record */[
              /* num */n,
              /* den */d
      ...
      return /* record */[
              /* num */Curry._2(Z.Bigint[/* divexact */24], n, g),
              /* den */Curry._2(Z.Bigint[/* divexact */24], d, g)
            ];
    }
  }
}
...
function make$4(n, d) {
  var sd = Curry._1(Z.Bigint[/* sign */45], d);
  if (sd === 0) {
    return /* record */[
            /* num */Curry._1(Z.Bigint[/* of_int */4], Curry._1(Z.Bigint[/* sign */45], n)),
            /* den */Z.Bigint[/* zero */1]
          ];
  } else if (sd > 0) {
    return make_real$4(n, d);
  } else {
    return make_real$4(Curry._1(Z.Bigint[/* neg */14], n), Curry._1(Z.Bigint[/* neg */14], d));
  }
}
...
function of_float$4(d) {
  if (d === Number.POSITIVE_INFINITY) {
    ...
    var match = Caml_float.caml_frexp_float(d);
    var m = Curry._1(Z.Bigint[/* of_float */8], Caml_float.caml_ldexp_float(match[0], 53));
    var e = match[1] - 53 | 0;
    if (e >= 0) {
      var n = Curry._2(Z.Bigint[/* shift_left */29], m, e);
      return /* record */[
              /* num */n,
              /* den */Z.Bigint[/* one */2]
            ];
    } else {
      return make_real$4(m, Curry._2(Z.Bigint[/* shift_left */29], Z.Bigint[/* one */2], -e | 0));
    }
  }
}
...
function of_string$4(s) {
  try {
    var i = $$String.index(s, /* "/" */47);
    return make$4(Curry._3(Z.Bigint[/* of_substring */10], s, 0, i), Curry._3(Z.Bigint[/* of_substring */10], s, i + 1 | 0, (s.length - i | 0) - 1 | 0));
  }
  catch (exn){
    if (exn === Caml_builtin_exceptions.not_found) {
      if (s === "inf" || s === "+inf") {
        ...
        var n = Curry._1(Z.Bigint[/* of_string */9], s);
        return /* record */[
                /* num */n,
                /* den */Z.Bigint[/* one */2]
              ];
...
function classify$4(n) {
  if (n[/* den */1] === Z.Bigint[/* zero */1]) {
    var match = Curry._1(Z.Bigint[/* sign */45], n[/* num */0]);
    var switcher = match + 1 | 0;
    if (switcher > 2 || switcher < 0) {
      return /* UNDEF */3;
    } else {
...
function sign$4(x) {
  return Curry._1(Z.Bigint[/* sign */45], x[/* num */0]);
}

function equal$4(x, y) {
  if (Curry._2(Z.Bigint[/* equal */40], x[/* num */0], y[/* num */0])) {
    return Curry._2(Z.Bigint[/* equal */40], x[/* den */1], y[/* den */1]);
  } else {
    return false;
  }
}
...
function compare$4(x, y) {
  ...
  if (exit === 1) {
    if (x[/* den */1] === y[/* den */1]) {
      return Curry._2(Z.Bigint[/* compare */39], x[/* num */0], y[/* num */0]);
    } else {
      return Curry._2(Z.Bigint[/* compare */39], Curry._2(Z.Bigint[/* mul */17], x[/* num */0], y[/* den */1]), Curry._2(Z.Bigint[/* mul */17], y[/* num */0], x[/* den */1]));
    }
  }
...
function to_string$4(n) {
  ...
  switch (match) {
    ...
    case 3 : 
        return "undef";
    case 4 : 
        if (Curry._2(Z.Bigint[/* equal */40], n[/* den */1], Z.Bigint[/* one */2])) {
          return Curry._1(Z.Bigint[/* to_string */38], n[/* num */0]);
        } else {
          return Curry._1(Z.Bigint[/* to_string */38], n[/* num */0]) + ("/" + Curry._1(Z.Bigint[/* to_string */38], n[/* den */1]));
        }
...
function to_bigint$4(x) {
  return Curry._2(Z.Bigint[/* div */18], x[/* num */0], x[/* den */1]);
}

function to_int$4(x) {
  return Curry._1(Z.Bigint[/* to_int */32], to_bigint$4(x));
}

function to_int32$4(x) {
  return Curry._1(Z.Bigint[/* to_int32 */33], to_bigint$4(x));
}

function to_int64$4(x) {
  return Curry._1(Z.Bigint[/* to_int64 */34], to_bigint$4(x));
}

function to_nativeint$4(x) {
  return Curry._1(Z.Bigint[/* to_nativeint */35], to_bigint$4(x));
}
...
function to_float$4(x) {
  ...
  switch (match) {
    ...
    case 4 : 
        var p = x[/* num */0];
        var q = x[/* den */1];
        var np = Curry._1(Z.Bigint[/* numbits */31], p);
        var nq = Curry._1(Z.Bigint[/* numbits */31], q);
        if (np <= 53 && nq <= 53) {
          return Caml_int64.to_float(Curry._1(Z.Bigint[/* to_int64 */34], p)) / Caml_int64.to_float(Curry._1(Z.Bigint[/* to_int64 */34], q));
        } else {
          var n = 55 - (np - nq | 0) | 0;
          var match$1 = n >= 0 ? /* tuple */[
              Curry._2(Z.Bigint[/* shift_left */29], p, n),
              q
            ] : /* tuple */[
              p,
              Curry._2(Z.Bigint[/* shift_left */29], q, -n | 0)
            ];
          var match$2 = Curry._2(Z.Bigint[/* ediv_rem */21], match$1[0], match$1[1]);
          var f = Curry._2(Z.Bigint[/* round_to_float */37], match$2[0], Curry._1(Z.Bigint[/* sign */45], match$2[1]) === 0);
          return Caml_float.caml_ldexp_float(f, -n | 0);
        }
...
function neg$4(x) {
  return /* record */[
          /* num */Curry._1(Z.Bigint[/* neg */14], x[/* num */0]),
          /* den */x[/* den */1]
        ];
}
...
function abs$4(x) {
  return /* record */[
          /* num */Curry._1(Z.Bigint[/* abs */13], x[/* num */0]),
          /* den */x[/* den */1]
        ];
}
...
function aors$4(zaors, x, y) {
  if (x[/* den */1] === y[/* den */1]) {
    ...
    return make_real$4(Curry._2(zaors, Curry._2(Z.Bigint[/* mul */17], x[/* num */0], y[/* den */1]), Curry._2(Z.Bigint[/* mul */17], y[/* num */0], x[/* den */1])), Curry._2(Z.Bigint[/* mul */17], x[/* den */1], y[/* den */1]));
  }
}
...
function add$4(x, y) {
  if (x[/* den */1] === Z.Bigint[/* zero */1] || y[/* den */1] === Z.Bigint[/* zero */1]) {
    ...
    return aors$4(Z.Bigint[/* add */15], x, y);
  }
}
...
function sub$4(x, y) {
  if (x[/* den */1] === Z.Bigint[/* zero */1] || y[/* den */1] === Z.Bigint[/* zero */1]) {
    ...
    return aors$4(Z.Bigint[/* sub */16], x, y);
  }
}
...
function mul$4(x, y) {
  if (x[/* den */1] === Z.Bigint[/* zero */1] || y[/* den */1] === Z.Bigint[/* zero */1]) {
    return /* record */[
            /* num */Curry._1(Z.Bigint[/* of_int */4], Caml_int32.imul(Curry._1(Z.Bigint[/* sign */45], x[/* num */0]), Curry._1(Z.Bigint[/* sign */45], y[/* num */0]))),
            /* den */Z.Bigint[/* zero */1]
          ];
  } else {
    return make_real$4(Curry._2(Z.Bigint[/* mul */17], x[/* num */0], y[/* num */0]), Curry._2(Z.Bigint[/* mul */17], x[/* den */1], y[/* den */1]));
  }
}

function inv$4(x) {
  var match = Curry._1(Z.Bigint[/* sign */45], x[/* num */0]);
  var exit = 0;
  var switcher = match + 1 | 0;
  if (switcher > 2 || switcher < 0) {
    exit = 1;
    ...
    switch (switcher) {
      case 0 : 
          return /* record */[
                  /* num */Curry._1(Z.Bigint[/* neg */14], x[/* den */1]),
                  /* den */Curry._1(Z.Bigint[/* neg */14], x[/* num */0])
                ];
      case 1 : 
          exit = 1;
          break;
...
function div$4(x, y) {
  if (Curry._1(Z.Bigint[/* sign */45], y[/* num */0]) >= 0) {
    ...
    return mul$4(x, /* record */[
                /* num */Curry._1(Z.Bigint[/* neg */14], y[/* den */1]),
                /* den */Curry._1(Z.Bigint[/* neg */14], y[/* num */0])
              ]);
  }
}
...
function mul_2exp$4(x, n) {
  if (x[/* den */1] === Z.Bigint[/* zero */1]) {
    ...
    return make_real$4(Curry._2(Z.Bigint[/* shift_left */29], x[/* num */0], n), x[/* den */1]);
  }
}
...
function div_2exp$4(x, n) {
  if (x[/* den */1] === Z.Bigint[/* zero */1]) {
    ...
    return make_real$4(x[/* num */0], Curry._2(Z.Bigint[/* shift_left */29], x[/* den */1], n));
  }
}
