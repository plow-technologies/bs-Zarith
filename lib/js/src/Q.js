...
function Rational(funarg) {
  var make_real = function (n, d) {
    if (n === funarg[/* zero */1] || d === funarg[/* one */2]) {
      ...
      var g = Curry._2(funarg[/* gcd */47], n, d);
      if (g === funarg[/* one */2]) {
        return /* record */[
                /* num */n,
                /* den */d
  ...
  var make = function (n, d) {
    var sd = Curry._1(funarg[/* sign */44], d);
    if (sd === 0) {
      return /* record */[
              /* num */Curry._1(funarg[/* of_int */4], Curry._1(funarg[/* sign */44], n)),
              /* den */funarg[/* zero */1]
            ];
    } else if (sd > 0) {
  ...
  var of_float = function (d) {
    if (d === Number.POSITIVE_INFINITY) {
      ...
      var e = match[1] - 53 | 0;
      if (e >= 0) {
        var n = Curry._2(funarg[/* shift_left */28], m, e);
        return /* record */[
                /* num */n,
                /* den */funarg[/* one */2]
              ];
      } else {
        return make_real(m, Curry._2(funarg[/* shift_left */28], funarg[/* one */2], -e | 0));
      }
    }
  };
  ...
  var classify = function (n) {
    if (n[/* den */1] === funarg[/* zero */1]) {
      var match = Curry._1(funarg[/* sign */44], n[/* num */0]);
  ...
  var sign = function (x) {
    return Curry._1(funarg[/* sign */44], x[/* num */0]);
  };
  var equal = function (x, y) {
    if (Curry._2(funarg[/* equal */39], x[/* num */0], y[/* num */0])) {
      return Curry._2(funarg[/* equal */39], x[/* den */1], y[/* den */1]);
    } else {
      return false;
    }
  };
  var compare = function (x, y) {
    ...
    if (exit === 1) {
      if (match$1 !== 2) {
        if (x[/* den */1] === y[/* den */1]) {
          return Curry._2(funarg[/* compare */38], x[/* num */0], y[/* num */0]);
        } else {
          return Curry._2(funarg[/* compare */38], Curry._2(funarg[/* mul */17], x[/* num */0], y[/* den */1]), Curry._2(funarg[/* mul */17], y[/* num */0], x[/* den */1]));
        }
      } else {
        return 1;
      }
  ...
  var to_string = function (n) {
    ...
    switch (match) {
      ...
      case 3 : 
          return "undef";
      case 4 : 
          if (Curry._2(funarg[/* equal */39], n[/* den */1], funarg[/* one */2])) {
            return Curry._1(funarg[/* to_string */37], n[/* num */0]);
          } else {
            return Curry._1(funarg[/* to_string */37], n[/* num */0]) + ("/" + Curry._1(funarg[/* to_string */37], n[/* den */1]));
          }
  ...
  var to_int = function (x) {
    return Curry._1(funarg[/* to_int */31], to_bigint(x));
  };
  var to_int32 = function (x) {
    return Curry._1(funarg[/* to_int32 */32], to_bigint(x));
  };
  var to_int64 = function (x) {
    return Curry._1(funarg[/* to_int64 */33], to_bigint(x));
  };
  var to_nativeint = function (x) {
    return Curry._1(funarg[/* to_nativeint */34], to_bigint(x));
  };
  var to_float = function (x) {
    ...
    switch (match) {
      ...
      case 4 : 
          var p = x[/* num */0];
          var q = x[/* den */1];
          var np = Curry._1(funarg[/* numbits */30], p);
          var nq = Curry._1(funarg[/* numbits */30], q);
          if (np <= 53 && nq <= 53) {
            return Caml_int64.to_float(Curry._1(funarg[/* to_int64 */33], p)) / Caml_int64.to_float(Curry._1(funarg[/* to_int64 */33], q));
          } else {
            var n = 55 - (np - nq | 0) | 0;
            var match$1 = n >= 0 ? /* tuple */[
                Curry._2(funarg[/* shift_left */28], p, n),
                q
              ] : /* tuple */[
                p,
                Curry._2(funarg[/* shift_left */28], q, -n | 0)
              ];
            var match$2 = Curry._2(funarg[/* ediv_rem */21], match$1[0], match$1[1]);
            var f = Curry._2(funarg[/* round_to_float */36], match$2[0], Curry._1(funarg[/* sign */44], match$2[1]) === 0);
  ...
  var mul = function (x, y) {
    if (x[/* den */1] === funarg[/* zero */1] || y[/* den */1] === funarg[/* zero */1]) {
      return /* record */[
              /* num */Curry._1(funarg[/* of_int */4], Caml_int32.imul(Curry._1(funarg[/* sign */44], x[/* num */0]), Curry._1(funarg[/* sign */44], y[/* num */0]))),
              /* den */funarg[/* zero */1]
            ];
    } else {
  ...
  var inv = function (x) {
    var match = Curry._1(funarg[/* sign */44], x[/* num */0]);
    var exit = 0;
    var switcher = match + 1 | 0;
    if (switcher > 2 || switcher < 0) {
      exit = 1;
  ...
  var div = function (x, y) {
    if (Curry._1(funarg[/* sign */44], y[/* num */0]) >= 0) {
      return mul(x, /* record */[
                  /* num */y[/* den */1],
                  /* den */y[/* num */0]
                ]);
  ...
  var mul_2exp = function (x, n) {
    if (x[/* den */1] === funarg[/* zero */1]) {
      ...
      return make_real(Curry._2(funarg[/* shift_left */28], x[/* num */0], n), x[/* den */1]);
    }
  };
  var div_2exp = function (x, n) {
    if (x[/* den */1] === funarg[/* zero */1]) {
      ...
      return make_real(x[/* num */0], Curry._2(funarg[/* shift_left */28], x[/* den */1], n));
    }
  };
