...
function cdiv(a, b) {
  ...
  if (Caml_obj.caml_greaterthan(match[1], 0)) {
    return quotient + 1 | 0;
  } else {
    return quotient;
  }
...
function fdiv(a, b) {
  var match = div_rem(a, b);
  var quotient = match[0];
  if (Caml_obj.caml_lessthan(match[1], 0)) {
    return quotient - 1 | 0;
  } else {
    return quotient;
  }
  ...
  if (exp < 0) {
    ...
    while(true) {
      ...
      if (exp$1 <= 0) {
        ...
        _acc = Caml_int32.imul(acc, base$1);
        _exp = exp$1 - 1 | 0;
        continue ;
      }
    };
...
var Overflow$1 = Caml_exceptions.create("Z.ZInt32.Overflow");
...
function of_int64$1(prim) {
  return prim[1] | 0;
}

function of_nativeint$1(prim) {
  return prim;
}
...
var of_string$1 = Caml_format.caml_int32_of_string;
...
function sub$1(prim, prim$1) {
  return prim - prim$1 | 0;
}

var mul$1 = Caml_int32.imul;

function mod(a, n) {
  return a - Caml_int32.imul(n, Caml_int32.div(a, n)) | 0;
}
...
function logand$1(prim, prim$1) {
  return prim & prim$1;
}

function logor$1(prim, prim$1) {
  return prim | prim$1;
}

function logxor$1(prim, prim$1) {
  return prim ^ prim$1;
}

function shift_left$1(prim, prim$1) {
  return (prim << prim$1);
}

function shift_right$1(prim, prim$1) {
  return (prim >> prim$1);
}
...
function to_nativeint$1(prim) {
  return prim;
}

function to_float$1(prim) {
  return prim;
}
...
var $less$1 = Caml_obj.caml_lessthan;

var $great$1 = Caml_obj.caml_greaterthan;

var $less$eq$1 = Caml_obj.caml_lessequal;

var $great$eq$1 = Caml_obj.caml_greaterequal;
...
var Overflow$2 = Caml_exceptions.create("Z.ZInt64.Overflow");
...
var of_nativeint$2 = Caml_int64.of_int32;

var of_float$2 = Caml_int64.of_float;

var of_string$2 = Caml_format.caml_int64_of_string;

function of_substring$2(s, pos, len) {
  return Caml_format.caml_int64_of_string($$String.sub(s, pos, len));
}
...
function numbits$2(n) {
  ...
  while(Caml_int64.gt(nref, count)) {
    if (/* int64 */[
        /* hi */nref[0] & count[0],
        /* lo */((nref[1] & count[1]) >>> 0)
      ] === Int64.one) {
...
function to_int$2(prim) {
  return prim[1] | 0;
}

function to_int32$2(prim) {
  return prim[1] | 0;
}
...
function round_to_float$2(x, exact) {
  return Caml_int64.to_float(exact ? x : Caml_int64.or_(x, /* int64 */[
                    /* hi */0,
                    /* lo */1
                  ]));
}
...
function is_even$2(i) {
  return Caml_int64.eq(mod$1(i, two$1), Int64.zero);
}

function is_odd$2(i) {
  return Caml_int64.neq(mod$1(i, two$1), Int64.zero);
}
  ...
  if (exp < 0) {
    ...
    while(true) {
      ...
      if (exp$1 <= 0) {
        ...
        _acc = Caml_int64.mul(acc, base$1);
        _exp = exp$1 - 1 | 0;
        continue ;
      }
    };
...
var $less$2 = Caml_obj.caml_lessthan;

var $great$2 = Caml_obj.caml_greaterthan;

var $less$eq$2 = Caml_obj.caml_lessequal;

var $great$eq$2 = Caml_obj.caml_greaterequal;
...
var Overflow$3 = Caml_exceptions.create("Z.ZNativeint.Overflow");
...
function of_int32$3(prim) {
  return prim;
}

function of_int64$3(prim) {
  return prim[1] | 0;
}

function of_nativeint$3(x) {
  return x;
}

function of_float$3(prim) {
  return prim | 0;
}

var of_string$3 = Caml_format.caml_nativeint_of_string;
...
function add$3(prim, prim$1) {
  return prim + prim$1;
}

function sub$3(prim, prim$1) {
  return prim - prim$1;
}

function mul$3(prim, prim$1) {
  return prim * prim$1;
}
...
function div$3(prim, prim$1) {
  return prim / prim$1 | 0;
}

var rem$3 = mod$2;

function div_rem$3(a, b) {
  return /* tuple */[
          a / b | 0,
          mod$2(a, b)
        ];
...
function sign$3(n) {
  if (n === 0) {
    return 0;
  } else if (Nativeint.compare(n, 0) < 0) {
    return -1;
  } else {
    return 1;
  }
...
function ediv_rem$prime$3(_a, _b, _cum) {
  while(true) {
    var cum = _cum;
    var b = _b;
    var a = _a;
    var a$1 = Nativeint.abs(a);
    var b$1 = Nativeint.abs(b);
    var r = a$1 - b$1;
    if (Caml_primitive.caml_nativeint_compare(a$1, b$1) === 1) {
      _cum = cum + Nativeint.one;
      _b = b$1;
      _a = r;
      continue ;
    } else {
...
function gt$3(x, y) {
  return Nativeint.compare(x, y) > 0;
}

function ediv_rem$3(a, b) {
  if (gt$3(a, Nativeint.minus_one)) {
    return div_rem$3(a, b);
  } else {
    var match = ediv_rem$prime$3(a, b, Nativeint.zero);
    return /* tuple */[
            -match[0],
            Nativeint.abs(match[1])
          ];
  }
}

function ediv$3(a, b) {
  return ediv_rem$3(a, b)[0];
}

function erem$3(a, b) {
  return ediv_rem$3(a, b)[1];
}

function logand$3(prim, prim$1) {
  return prim & prim$1;
}

function logor$3(prim, prim$1) {
  return prim | prim$1;
}

function logxor$3(prim, prim$1) {
  return prim ^ prim$1;
}

function shift_left$3(prim, prim$1) {
  return (prim << prim$1);
}

function shift_right$3(prim, prim$1) {
  return (prim >> prim$1);
}

function numbits$3(n) {
  var nref = n;
  var count = Nativeint.zero;
  while(nref > count) {
    if ((nref & count) === Nativeint.one) {
      count += Nativeint.one;
    } else {
      nref = (nref >>> 1);
    }
...
function to_int$3(prim) {
  return prim;
}

function to_int32$3(prim) {
  return prim;
}

var to_int64$3 = Caml_int64.of_int32;

function to_nativeint$3(x) {
  return x;
}

function to_float$3(prim) {
  return prim;
}

function round_to_float$3(x, exact) {
  var m = Caml_int64.of_int32(x);
  return Caml_int64.to_float(exact ? m : Caml_int64.or_(m, /* int64 */[
                    /* hi */0,
                    /* lo */1
...
function leq$3(x, y) {
  return Nativeint.compare(x, y) < 1;
}
...
function cdiv$3(a, b) {
  var match = div_rem$3(a, b);
  var quotient = match[0];
  if (gt$3(match[1], Nativeint.zero)) {
    return quotient + Nativeint.one;
  } else {
    return quotient;
  }
}
...
function fdiv$3(a, b) {
  var match = div_rem$3(a, b);
  var quotient = match[0];
  if (lt$3(match[1], Nativeint.zero)) {
    return quotient - Nativeint.one;
  } else {
    return quotient;
  }
...
function is_even$3(i) {
  return mod$2(i, two$2) === Nativeint.zero;
}
...
function pow$3(base, exp) {
  if (exp < 0) {
    ...
    return Nativeint.one;
  } else if (exp === 1) {
    return base;
  } else {
    var base$1 = base;
    var _exp = exp;
    var _acc = Nativeint.one;
    while(true) {
      var acc = _acc;
      var exp$1 = _exp;
      if (exp$1 <= 0) {
...
var $star$star$3 = pow$3;

var $less$3 = Caml_obj.caml_lessthan;

var $great$3 = Caml_obj.caml_greaterthan;

var $less$eq$3 = Caml_obj.caml_lessequal;

var $great$eq$3 = Caml_obj.caml_greaterequal;

function $less$great$3(a, b) {
  return a !== b;
}

var ZNativeint = /* module */[
  /* Overflow */Overflow$3,
  /* zero */Nativeint.zero,
  /* one */Nativeint.one,
  /* minus_one */Nativeint.minus_one,
  /* of_int */of_int$3,
  /* of_int32 */of_int32$3,
  /* of_int64 */of_int64$3,
  /* of_nativeint */of_nativeint$3,
  /* of_bigint */Bigint.to_nativeint,
  /* of_float */of_float$3,
  /* of_string */of_string$3,
  /* of_substring */of_substring$3,
  /* succ */succ$3,
  /* pred */pred$3,
  /* abs */Nativeint.abs,
  /* neg */neg$3,
  ...
  /* to_bigint */Bigint.of_nativeint,
  /* to_float */to_float$3,
  /* round_to_float */round_to_float$3,
...
var Overflow$4 = Caml_exceptions.create("Z.ZBigint.Overflow");
...
var $star$star$4 = Bigint.pow;

var $less$4 = Caml_obj.caml_lessthan;

var $great$4 = Caml_obj.caml_greaterthan;

var $less$eq$4 = Caml_obj.caml_lessequal;

var $great$eq$4 = Caml_obj.caml_greaterequal;
...
var ZBigint = /* module */[
  ...
  /* of_nativeint */Bigint.of_nativeint,
  /* of_bigint */of_bigint,
  ...
  /* to_nativeint */Bigint.to_nativeint,
  /* to_bigint */to_bigint,
