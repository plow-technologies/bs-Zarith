...
function trimzeros(listy) {
  var trimzeros$prime = function (listy$prime) {
    ...
    var car = listy$prime.hd;
    if (car === 0 && !listy$prime.tl) {
      return /* [] */0;
    }
    var cdr$prime = trimzeros$prime(listy$prime.tl);
    if (car !== 0 || cdr$prime) {
      return {
              hd: car,
              tl: cdr$prime
...
function cmp(_list1, _list2) {
  while(true) {
    ...
    if (Caml_obj.caml_lessthan(List.hd(reverselist1), List.hd(reverselist2))) {
      return -1;
    }
  ...
  while(true) {
    ...
    if (list2) {
      if (list1) {
        ...
        return {
                hd: sum % 10,
                tl: add$prime(List.tl(list1), List.tl(list2), sum / 10 | 0)
              };
      }
      _carry = 0;
      _list1 = {
...
function sub$prime(list1, _list2, _carry) {
  while(true) {
    ...
    if (diff >= 0) {
      return {
              hd: diff,
              tl: sub$prime(List.tl(list1), List.tl(list2), 0)
            };
    } else {
      return {
              hd: diff + 10 | 0,
              tl: sub$prime(List.tl(list1), List.tl(list2), 1)
            };
    }
  };
}
...
function add(param, param$1) {
  ...
  if (neg1 === neg2) {
    return /* Bigint */{
            _0: neg1,
            _1: add$prime(value1, value2, 0)
          };
  } else if (cmp(value1, value2) === 1) {
    return /* Bigint */{
            _0: neg1,
            _1: trimzeros(sub$prime(value1, value2, 0))
          };
  } else if (cmp(value1, value2) === -1) {
    return /* Bigint */{
            _0: neg2,
            _1: trimzeros(sub$prime(value2, value1, 0))
          };
  } else {
    return zero;
  }
...
function mul(param, param$1) {
  var match = mul$prime(param._1, param$1._1, {
        hd: 1,
        tl: /* [] */0
      });
  var product = match[1];
...
function div_rem(param, param$1) {
  var neg1 = param._0;
  var match = div_rem$prime(param._1, param$1._1, {
        hd: 1,
        tl: /* [] */0
      });
  var rem = match[1];
...
function is_even(param) {
  var match = div_rem$prime(param._1, {
        hd: 2,
        tl: /* [] */0
      }, {
        hd: 1,
