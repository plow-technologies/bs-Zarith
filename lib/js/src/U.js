...
function mul(x, y) {
  return Caml_int32.imul(x, y) & 255;
}
...
function logand(prim, prim$1) {
  return prim & prim$1;
}

function logor(prim, prim$1) {
  return prim | prim$1;
}

function logxor(prim, prim$1) {
  return prim ^ prim$1;
}
...
function shiftRight(prim, prim$1) {
...
function mul$1(x, y) {
  return Caml_int32.imul(x, y) & 65535;
}
...
function shiftRight$1(prim, prim$1) {
  return (prim >>> prim$1) | 0;
}
...
var max$1 = Caml_obj.caml_max;

var min$1 = Caml_obj.caml_min;
...
var maxInt = Caml_format.caml_int64_of_string("4294967295");
...
function ofString$2(x) {
  var match = Belt_Int.fromString(x);
  if (match !== undefined) {
    return Caml_int64.and_(Caml_int64.of_int32(match), maxInt);
  }
  
}

var zero$2 = Caml_int64.and_(/* int64 */[
      /* hi */0,
      /* lo */0
    ], maxInt);

var one$2 = Caml_int64.and_(/* int64 */[
      /* hi */0,
      /* lo */1
    ], maxInt);
...
var max$2 = Caml_obj.caml_max;

var min$2 = Caml_obj.caml_min;
...
var max$3 = Caml_obj.caml_max;

var min$3 = Caml_obj.caml_min;
