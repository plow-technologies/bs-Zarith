...
Jest.describe("Natural", (function (param) {
        ...
        Jest.test("ofInt64 on a negative number should throw an error", (function (param) {
                return Jest.Expect.toEqual(undefined, Jest.Expect.expect(Natural.ofInt64(/* int64 */[
                                    /* hi */-1,
                                    /* lo */4294967295
                                  ])));
              }));
        ...
        Jest.test("unsafeOfInt on a negative number should throw an error", (function (param) {
                return Jest.Expect.toThrowException(Natural.Underflow, Jest.Expect.expect((function (param) {
        ...
        return Jest.test("div", (function (param) {
