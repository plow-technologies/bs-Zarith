...
Jest.describe("Bigfloat.add", (function (param) {
        ...
        return Jest.test("1.000000 + 9.0000000000", (function (param) {
                      return Jest.Expect.toEqual(Bigfloat.mkBigfloat(Bigint.of_int64(Caml_int64.mk(1021438976, 44)), 10), Jest.Expect.expect(Bigfloat.add(Bigfloat.mkBigfloat(Bigint.of_int(10000000), 6), Bigfloat.mkBigfloat(Bigint.of_int64(Caml_int64.mk(-194313216, 20)), 10))));
                    }));
      }));
...
Jest.describe("Bigfloat.adjustDecimalPos", (function (param) {
        ...
        return Jest.test("59.787800, 5", (function (param) {
                      return Jest.Expect.toEqual([
                                  Bigfloat.mkBigfloat(Bigint.of_int64(Caml_int64.mk(59787800, 0)), 6),
                                  Bigfloat.mkBigfloat(Bigint.of_int(5000000), 6)
                                ], Jest.Expect.expect(Bigfloat.adjustDecimalPos(Bigfloat.mkBigfloat(Bigint.of_int64(Caml_int64.mk(59787800, 0)), 6), Bigfloat.mkBigfloat(Bigint.of_int(5), 0))));
                    }));
      }));
...
Jest.describe("Bigfloat.div", (function (param) {
        ...
        Jest.test("99.000000 / 2.0000000000", (function (param) {
                return Jest.Expect.toEqual(Bigfloat.mkBigfloat(Bigint.of_string("490000000000"), 10), Jest.Expect.expect(Bigfloat.div(Bigfloat.mkBigfloat(Bigint.of_int64(Caml_int64.mk(99000000, 0)), 6), Bigfloat.mkBigfloat(Bigint.of_string("20000000000"), 10))));
              }));
        return Jest.test("99.0 / 2.0000000000", (function (param) {
                      return Jest.Expect.toEqual(Bigfloat.mkBigfloat(Bigint.of_string("490000000000"), 10), Jest.Expect.expect(Bigfloat.div(Bigfloat.mkBigfloat(Bigint.of_int64(Caml_int64.mk(990, 0)), 1), Bigfloat.mkBigfloat(Bigint.of_string("20000000000"), 10))));
                    }));
      }));
...
Jest.describe("Bigfloat.ofString", (function (param) {
        ...
        Jest.test("'3,267'", (function (param) {
                return Jest.Expect.toEqual(Bigfloat.mkBigfloat(Bigint.of_int64(Caml_int64.mk(-1027967296, 0)), 6), Jest.Expect.expect(Bigfloat.ofString("3,267", 6)));
              }));
        return Jest.test("'3,267.1'", (function (param) {
                      return Jest.Expect.toEqual(Bigfloat.mkBigfloat(Bigint.of_int64(Caml_int64.mk(-1027867296, 0)), 6), Jest.Expect.expect(Bigfloat.ofString("3,267.1", 6)));
                    }));
      }));
