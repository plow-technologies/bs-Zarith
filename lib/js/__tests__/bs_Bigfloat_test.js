...
Jest.describe("Bigfloat.add", (function (param) {
        ...
        return Jest.test("1.000000 + 9.0000000000", (function (param) {
                      return Jest.Expect.toEqual(Bigfloat.mkBigfloat(Bigint.of_int64(/* int64 */[
                                          /* hi */44,
                                          /* lo */1021438976
                                        ]), 10), Jest.Expect.expect(Bigfloat.add(Bigfloat.mkBigfloat(Bigint.of_int(10000000), 6), Bigfloat.mkBigfloat(Bigint.of_int64(/* int64 */[
                                                  /* hi */20,
                                                  /* lo */4100654080
                                                ]), 10))));
                    }));
...
Jest.describe("Bigfloat.sub", (function (param) {
        ...
        return Jest.test("20.00 - 0.5", (function (param) {
...
Jest.describe("Bigfloat.mul", (function (param) {
        ...
        return Jest.test("31.123 * 0.02", (function (param) {
...
Jest.describe("Bigfloat.firstNonZero", (function (param) {
        ...
        return Jest.test("90000", (function (param) {
                      return Jest.Expect.toEqual(4, Jest.Expect.expect(Bigint.firstNonZero(Bigint.of_int(90000))));
                    }));
      }));

Jest.describe("Bigfloat.adjustDecimals", (function (param) {
        Jest.test("0, 0", (function (param) {
                return Jest.Expect.toEqual(/* tuple */[
                            Bigfloat.mkBigfloat(Bigint.one, 0),
                            Bigfloat.mkBigfloat(Bigint.one, 0)
                          ], Jest.Expect.expect(Bigfloat.adjustDecimals(Bigfloat.mkBigfloat(Bigint.one, 0), Bigfloat.mkBigfloat(Bigint.one, 0))));
              }));
        Jest.test("12.34, 5.6", (function (param) {
                return Jest.Expect.toEqual(/* tuple */[
                            Bigfloat.mkBigfloat(Bigint.of_int(1234), 2),
                            Bigfloat.mkBigfloat(Bigint.of_int(560), 2)
                          ], Jest.Expect.expect(Bigfloat.adjustDecimals(Bigfloat.mkBigfloat(Bigint.of_int(1234), 2), Bigfloat.mkBigfloat(Bigint.of_int(56), 1))));
              }));
        return Jest.test("59.787800, 5", (function (param) {
                      return Jest.Expect.toEqual(/* tuple */[
                                  Bigfloat.mkBigfloat(Bigint.of_int64(/* int64 */[
                                            /* hi */0,
                                            /* lo */59787800
                                          ]), 6),
                                  Bigfloat.mkBigfloat(Bigint.of_int(5000000), 6)
                                ], Jest.Expect.expect(Bigfloat.adjustDecimals(Bigfloat.mkBigfloat(Bigint.of_int64(/* int64 */[
                                                  /* hi */0,
                                                  /* lo */59787800
...
Jest.describe("Bigfloat.div", (function (param) {
        ...
        Jest.test("99.000000 / 2.0000000000", (function (param) {
                return Jest.Expect.toEqual(Bigfloat.mkBigfloat(Bigint.of_string("490000000000"), 10), Jest.Expect.expect(Bigfloat.div(Bigfloat.mkBigfloat(Bigint.of_int64(/* int64 */[
                                            /* hi */0,
                                            /* lo */99000000
                                          ]), 6), Bigfloat.mkBigfloat(Bigint.of_string("20000000000"), 10))));
              }));
        return Jest.test("99.0 / 2.0000000000", (function (param) {
                      return Jest.Expect.toEqual(Bigfloat.mkBigfloat(Bigint.of_string("490000000000"), 10), Jest.Expect.expect(Bigfloat.div(Bigfloat.mkBigfloat(Bigint.of_int64(/* int64 */[
                                                  /* hi */0,
                                                  /* lo */990
...
Jest.describe("Bigfloat.ofString", (function (param) {
        Jest.test("'0'", (function (param) {
                return Jest.Expect.toEqual(/* Ok */Block.__(0, [Bigfloat.mkBigfloat(Bigint.zero, 0)]), Jest.Expect.expect(Bigfloat.ofString("0", 0)));
              }));
        Jest.test("'1'", (function (param) {
                return Jest.Expect.toEqual(/* Ok */Block.__(0, [Bigfloat.mkBigfloat(Bigint.of_int(10), 1)]), Jest.Expect.expect(Bigfloat.ofString("1", 1)));
              }));
        Jest.test("'1.0'", (function (param) {
                return Jest.Expect.toEqual(/* Ok */Block.__(0, [Bigfloat.mkBigfloat(Bigint.of_int(10), 1)]), Jest.Expect.expect(Bigfloat.ofString("1.0", 1)));
              }));
        Jest.test("'1.01'", (function (param) {
                return Jest.Expect.toEqual(/* Ok */Block.__(0, [Bigfloat.mkBigfloat(Bigint.of_int(101), 2)]), Jest.Expect.expect(Bigfloat.ofString("1.01", 2)));
              }));
        Jest.test("'1.023'", (function (param) {
                return Jest.Expect.toEqual(/* Ok */Block.__(0, [Bigfloat.mkBigfloat(Bigint.of_int(1023), 3)]), Jest.Expect.expect(Bigfloat.ofString("1.023", 3)));
              }));
        Jest.test("'123.456789'", (function (param) {
                return Jest.Expect.toEqual(/* Ok */Block.__(0, [Bigfloat.mkBigfloat(Bigint.of_int(123456789), 6)]), Jest.Expect.expect(Bigfloat.ofString("123.456789", 6)));
              }));
        Jest.test("'0.0089'", (function (param) {
                return Jest.Expect.toEqual(/* Ok */Block.__(0, [Bigfloat.mkBigfloat(Bigint.of_int(89), 4)]), Jest.Expect.expect(Bigfloat.ofString("00.0089", 4)));
              }));
        Jest.test("'984'", (function (param) {
                return Jest.Expect.toEqual(/* Ok */Block.__(0, [Bigfloat.mkBigfloat(Bigint.of_int(984000000), 6)]), Jest.Expect.expect(Bigfloat.ofString("984", 6)));
              }));
        Jest.test("'3,267'", (function (param) {
                return Jest.Expect.toEqual(/* Ok */Block.__(0, [Bigfloat.mkBigfloat(Bigint.of_int64(/* int64 */[
                                        /* hi */0,
                                        /* lo */3267000000
                                      ]), 6)]), Jest.Expect.expect(Bigfloat.ofString("3,267", 6)));
              }));
        return Jest.test("'3,267.1'", (function (param) {
                      return Jest.Expect.toEqual(/* Ok */Block.__(0, [Bigfloat.mkBigfloat(Bigint.of_int64(/* int64 */[
                                              /* hi */0,
                                              /* lo */3267100000
...
Jest.describe("Bigfloat.toString", (function (param) {
        ...
        return Jest.test("67.004020", (function (param) {
...
Jest.describe("Bigfloat.toStringWithCommas", (function (param) {
        ...
        return Jest.test("45,657,923.004020", (function (param) {
...
Jest.describe("Bigfloat.compare", (function (param) {
        ...
        return Jest.test("compare(10,9.234)", (function (param) {
