...
Jest.describe("Bigint", (function (param) {
        ...
        return Jest.test("big to string", (function (param) {
...
Jest.test("to_int greater than max_int should throw Overflow", (function (param) {
        return Jest.Expect.toThrowException(Bigint.Overflow, Jest.Expect.expect((function (param) {
...
Jest.test("to_navtiveint max_int", (function (param) {
        return Jest.Expect.toEqual(1, Jest.Expect.expect(Bigint.to_nativeint(Bigint.of_nativeint(1))));
      }));
...
Jest.test("3 <> 2", (function (param) {
        return Jest.Expect.toEqual(true, Jest.Expect.expect(Caml_obj.caml_notequal(Bigint.of_int(3), Bigint.of_int(2))));
      }));

Jest.test("2 <> 2", (function (param) {
        return Jest.Expect.toEqual(false, Jest.Expect.expect(Caml_obj.caml_notequal(Bigint.of_int(2), Bigint.of_int(2))));
      }));

Jest.test("0 <> 1", (function (param) {
        return Jest.Expect.toEqual(true, Jest.Expect.expect(Caml_obj.caml_notequal(Bigint.of_int(0), Bigint.of_int(1))));
      }));
