...
describe("Bigint", (function () {
        ...
        Jest.test("zero equal to (Bigint.of_int 0)", (function () {
                return Jest.Expect[/* toEqual */12](Bigint.of_string("0"), Jest.Expect[/* expect */0](Bigint.zero$prime));
              }));
        Jest.test("one equal to (Bigint.of_int 1)", (function () {
        ...
        Jest.test("0 + 0", (function () {
                var z = Bigint.add(Bigint.zero$prime, Bigint.zero$prime);
                return Jest.Expect[/* toEqual */12](Bigint.zero$prime, Jest.Expect[/* expect */0](z));
              }));
